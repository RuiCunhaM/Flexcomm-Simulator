...
MockNetDevice::MockNetDevice () : m_node (0), m_mtu (0xffff), m_ifIndex (0), m_linkUp (true)
{
  NS_LOG_FUNCTION (this);
}

void
MockNetDevice::Receive (Ptr<Packet> packet, uint16_t protocol, Address to, Address from,
...
bool
MockNetDevice::SendFrom (Ptr<Packet> p, const Address &source, const Address &dest,
