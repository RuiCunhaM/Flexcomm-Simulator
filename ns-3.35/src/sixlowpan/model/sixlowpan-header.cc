...
TypeId
SixLowPanHc1::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
...
TypeId
SixLowPanFrag1::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
...
SixLowPanFragN::SixLowPanFragN () : m_datagramSize (0), m_datagramTag (0), m_datagramOffset (0)
{
}
/*
...
TypeId
SixLowPanFragN::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
...
TypeId
SixLowPanIpv6::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
...
TypeId
SixLowPanIphc::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
...
SixLowPanIphc::GetTf (void) const
{
...
bool
SixLowPanIphc::GetNh (void) const
{
...
SixLowPanIphc::GetHlim (void) const
{
...
bool
SixLowPanIphc::GetCid (void) const
{
...
bool
SixLowPanIphc::GetSac (void) const
{
...
SixLowPanIphc::GetSam (void) const
{
  return HeaderCompression_e ((m_baseFormat >> 4) & 0x3);
}

const uint8_t *
SixLowPanIphc::GetSrcInlinePart (void) const
{
...
bool
SixLowPanIphc::GetDac (void) const
{
...
SixLowPanIphc::HeaderCompression_e
SixLowPanIphc::GetDam (void) const
{
  return HeaderCompression_e (m_baseFormat & 0x3);
}

const uint8_t *
SixLowPanIphc::GetDstInlinePart (void) const
{
...
uint8_t
SixLowPanIphc::GetSrcContextId (void) const
{
...
uint8_t
SixLowPanIphc::GetDstContextId (void) const
{
...
uint8_t
SixLowPanIphc::GetEcn (void) const
{
  return m_ecn;
}
...
uint8_t
SixLowPanIphc::GetDscp (void) const
{
  return m_dscp;
}
...
uint32_t
SixLowPanIphc::GetFlowLabel (void) const
{
  return m_flowLabel;
}
...
uint8_t
SixLowPanIphc::GetNextHeader (void) const
{
  return m_nextHeader;
}
...
uint8_t
SixLowPanIphc::GetHopLimit (void) const
{
  return m_hopLimit;
}
...
TypeId
SixLowPanNhcExtension::GetTypeId (void)
{
...
TypeId
SixLowPanNhcExtension::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
...
SixLowPanNhcExtension::GetEid (void) const
{
...
uint8_t
SixLowPanNhcExtension::GetNextHeader (void) const
{
...
bool
SixLowPanNhcExtension::GetNh (void) const
{
...
TypeId
SixLowPanUdpNhcExtension::GetTypeId (void)
{
...
TypeId
SixLowPanUdpNhcExtension::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
...
SixLowPanUdpNhcExtension::GetPorts (void) const
{
...
uint16_t
SixLowPanUdpNhcExtension::GetSrcPort (void) const
{
  return m_srcPort;
}
...
uint16_t
SixLowPanUdpNhcExtension::GetDstPort (void) const
{
  return m_dstPort;
}
...
bool
SixLowPanUdpNhcExtension::GetC (void) const
{
  return ((m_baseFormat >> 2) & 0x1);
}
...
uint16_t
SixLowPanUdpNhcExtension::GetChecksum (void) const
{
  return m_checksum;
}
...
TypeId
SixLowPanBc0::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
...
uint8_t
SixLowPanBc0::GetSequenceNumber (void) const
{
  return m_seqNumber;
}
...
TypeId
SixLowPanMesh::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
...
Address
SixLowPanMesh::GetOriginator (void) const
{
  return m_src;
}
...
Address
SixLowPanMesh::GetFinalDst (void) const
{
  return m_dst;
}
...
uint8_t
SixLowPanMesh::GetHopsLeft (void) const
{
  return m_hopsLeft;
}
