...
class SwitchStatsTestCase1 : public TestCase
{
public:
  SwitchStatsTestCase1 ();
  virtual ~SwitchStatsTestCase1 ();
...
//
void
SwitchStatsTestCase1::DoRun (void)
{
...
//
class SwitchStatsTestSuite : public TestSuite
{
public:
