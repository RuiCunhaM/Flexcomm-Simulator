...
PyObject *
_wrap_Simulator_Schedule (PyNs3Simulator *PYBINDGEN_UNUSED (dummy), PyObject *args,
                          PyObject *kwargs, PyObject **return_exception)
{
  ...
  py_EventId->obj =
      new ns3::EventId (ns3::Simulator::Schedule (*((PyNs3Time *) py_time)->obj, py_event_impl));
...
PyObject *
_wrap_Simulator_ScheduleNow (PyNs3Simulator *PYBINDGEN_UNUSED (dummy), PyObject *args,
                             PyObject *kwargs, PyObject **return_exception)
{
  PyObject *exc_type, *traceback;
  PyObject *py_callback;
...
PyObject *
_wrap_Simulator_ScheduleWithContext (PyNs3Simulator *PYBINDGEN_UNUSED (dummy), PyObject *args,
                                     PyObject *kwargs, PyObject **return_exception)
{
  PyObject *exc_type, *traceback;
  ...
  if (PyTuple_GET_SIZE (args) < 3)
    {
      PyErr_SetString (PyExc_TypeError,
                       "ns3.Simulator.ScheduleWithContext needs at least 3 arguments");
      goto error;
    }
...
PyObject *
_wrap_Simulator_ScheduleDestroy (PyNs3Simulator *PYBINDGEN_UNUSED (dummy), PyObject *args,
                                 PyObject *kwargs, PyObject **return_exception)
{
  PyObject *exc_type, *traceback;
  PyObject *py_callback;
...
PyObject *
_wrap_TypeId_LookupByNameFailSafe (PyNs3TypeId *PYBINDGEN_UNUSED (dummy), PyObject *args,
                                   PyObject *kwargs, PyObject **return_exception)
{
  bool ok;
  const char *name;
                            ...
                            PyObject **return_exception)
{
  ...
  if (!PyArg_ParseTupleAndKeywords (args, kwargs, (char *) "ss|sO", (char **) keywords, &name,
                                    &help, &variable, &py_namespace))
    {
      PyObject *exc_type, *traceback;
      PyErr_Fetch (&exc_type, return_exception, &traceback);
      Py_XDECREF (exc_type);
  ...
  ns3::Ptr<CommandLinePythonValueSetter> setter =
      ns3::Create<CommandLinePythonValueSetter> (py_namespace, variable);
  self->obj->AddValue (name, help,
                       ns3::MakeCallback (&CommandLinePythonValueSetter::Parse, setter));
...
PythonSimulator::PythonSimulator () : m_stopped (false), m_failed (false), m_isCheckPending (false)
{
