...
Conversions ()
{
  ...
  std::cout << "\nConversions: "
            ...
            << "\nIn Kilometers: " << moonDistance.As (Unit::Kilometer) << std::endl;
}
...
DivAndMod ()
{
  ...
  std::cout << "\nHow many times can a " << totalLen.As (Unit::Foot) << " length "
            << "be split into " << pieceLen.As (Unit::Foot) << " sized pieces? " << count
            << "\nremainder: " << remainder.As (Unit::Foot) << std::endl;

  std::cout << "\nHow much remains after splitting a " << totalLen.As (Unit::Foot)
            << " length into " << pieceLen.As (Unit::Foot) << " sized pieces? "
            << Mod (totalLen, pieceLen).As (Unit::Foot) << std::endl;
}
