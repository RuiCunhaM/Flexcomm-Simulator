...
Histogram (Ptr<RandomVariableStream> rndvar, unsigned int probes, double precision,
...
main (int argc, char *argv[])
{
...

  {
    ...
    plot.AddDataset (Histogram (x1, probes, precision, "ParetoRandomVariable scale=1.0 shape=1.5"));
    ...
    plot.AddDataset (Histogram (x2, probes, precision, "ParetoRandomVariable scale=1.0 shape=2.0"));
    ...
    plot.AddDataset (Histogram (x3, probes, precision, "ParetoRandomVariable scale=1.0 shape=2.5"));
...

  {
    ...
    plot.AddDataset (
        Gnuplot2dFunction ("NormalDist {/Symbol m}=0.0 {/Symbol s}=1.0", "NormalDist(x,0.0,1.0)"));
  ...
  */
...

  {
    ...
    plot.AddDataset (Histogram (x1, probes, precision, "ErlangRandomVariable k=1 {/Symbol l}=1.0"));
    ...
    plot.AddDataset (Histogram (x2, probes, precision, "ErlangRandomVariable k=2 {/Symbol l}=1.0"));
    ...
    plot.AddDataset (Histogram (x3, probes, precision, "ErlangRandomVariable k=3 {/Symbol l}=1.0"));
    ...
    plot.AddDataset (Histogram (x4, probes, precision, "ErlangRandomVariable k=5 {/Symbol l}=1.0"));
    ...
    plot.AddDataset (Histogram (x5, probes, precision, "ErlangRandomVariable k=2 {/Symbol l}=2.0"));
    ...
    plot.AddDataset (Histogram (x6, probes, precision, "ErlangRandomVariable k=2 {/Symbol l}=3.0"));
    ...
    plot.AddDataset (Histogram (x7, probes, precision, "ErlangRandomVariable k=2 {/Symbol l}=5.0"));
