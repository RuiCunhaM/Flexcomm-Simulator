 ...
 */
inline uint32_t
getblock (const uint32_t *p, std::size_t i)
{
  return p[i];
}
/** \copydoc getblock(const uint32_t*,std::size_t) */
inline uint64_t
getblock (const uint64_t *p, std::size_t i)
{
  return p[i];
}
...
void
MurmurHash3_x86_32 (const void *key, std::size_t len, uint32_t seed, void *out)
{
  uint32_t h1;
...
void
MurmurHash3_x86_32_incr (const void *key, std::size_t len, uint32_t seed, void *out)
{
...
void
MurmurHash3_x86_32_fin (std::size_t len, uint32_t seed, void *out)
{
  uint32_t h1 = seed;
 ...
 */
void
MurmurHash3_x86_128 (const void *key, const std::size_t len, uint32_t seed, void *out)
{
  uint32_t seeds[4];
  uint32_t h[4];
...
void
MurmurHash3_x86_128_incr (const void *key, const std::size_t len, uint32_t *seeds, void *out)
{
  const uint8_t *data = (const uint8_t *) key;
...
//PDB - incremental hashing - finalization
void
MurmurHash3_x86_128_fin (const std::size_t len, uint32_t *seeds, void *out)
{
  //----------
  // finalization
...
void
MurmurHash3_x64_128 (const void *key, const std::size_t len, const uint32_t seed, void *out)
{
  const uint8_t *data = (const uint8_t *) key;
  const std::size_t nblocks = len / 16; //PDB: was const int nblocks
...
Murmur3::GetHash64 (const char *buffer, const std::size_t size)
{
  ...
  MurmurHash3_x86_128_incr (buffer, static_cast<int> (size), (uint32_t *) (void *) m_hash64,
                            m_hash64);
  m_size64 += size;
