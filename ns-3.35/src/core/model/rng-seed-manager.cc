 ...
 */
static ns3::GlobalValue g_rngSeed ("RngSeed", "The global seed of all rng streams",
 ...
 */
static ns3::GlobalValue g_rngRun ("RngRun", "The substream index used for all streams",
                                  ns3::UintegerValue (1), ns3::MakeUintegerChecker<uint64_t> ());

uint32_t
RngSeedManager::GetSeed (void)
{
...
uint64_t
RngSeedManager::GetNextStreamIndex (void)
{
  NS_LOG_FUNCTION_NOARGS ();
