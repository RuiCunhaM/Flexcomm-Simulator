...
public:
   ...
   */
  inline int64x64_t (double v) : _v (v)
  {
  }
  inline int64x64_t (long double v) : _v (v)
  {
  }
  /**@}*/
  ...
  inline int64x64_t (long long int v) : _v (static_cast<double> (v))
  {
  }
  ...
  inline int64x64_t (unsigned long long int v) : _v (static_cast<double> (v))
  {
  }
  /**@}*/
  /**
