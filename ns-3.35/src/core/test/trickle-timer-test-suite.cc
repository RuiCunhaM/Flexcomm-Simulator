...
TrickleTimerTestCase::TrickleTimerTestCase () : TestCase ("Check the Trickle Timer algorithm")
{
}
...
TrickleTimerTestCase::ConsistentEvent (Time interval, TrickleTimer *tricklePtr)
{
  ...
  Simulator::Schedule (interval, &TrickleTimerTestCase::ConsistentEvent, this, interval,
                       tricklePtr);
}
