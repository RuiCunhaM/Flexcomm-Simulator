...
Hash32FunctionPtrTestCase::Hash32FunctionPtrTestCase () : HashTestCase ("Hash32FunctionPtr: ")
{
}
...
Hash64FunctionPtrTestCase::Hash64FunctionPtrTestCase () : HashTestCase ("Hash64FunctionPtr: ")
{
}
