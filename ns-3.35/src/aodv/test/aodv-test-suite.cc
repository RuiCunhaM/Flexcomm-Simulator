...
NeighborTest::DoRun ()
{
  ...
  NS_TEST_EXPECT_MSG_EQ (neighbor->IsNeighbor (Ipv4Address ("1.2.3.4")), true, "Neighbor exists");
  NS_TEST_EXPECT_MSG_EQ (neighbor->GetExpireTime (Ipv4Address ("1.2.3.4")), Seconds (10),
                         "Known expire time");
  NS_TEST_EXPECT_MSG_EQ (neighbor->GetExpireTime (Ipv4Address ("4.3.2.1")), Seconds (0),
                         "Known expire time");
...
struct RreqHeaderTest : public TestCase
{
  ...
  DoRun ()
  {
    RreqHeader h (/*flags*/ 0, /*reserved*/ 0, /*hopCount*/ 6, /*requestID*/ 1,
...
struct RrepHeaderTest : public TestCase
{
  ...
  DoRun ()
  {
    RrepHeader h (/*prefixSize*/ 0, /*hopCount*/ 12, /*dst*/ Ipv4Address ("1.2.3.4"),
                  /*dstSeqNo*/ 2,
...
struct QueueEntryTest : public TestCase
{
   ...
   */
  void
  Unicast (Ptr<Ipv4Route> route, Ptr<const Packet> packet, const Ipv4Header &header)
  {
  }
  /**
   * Error test function
   ...
   */
  void
  Error (Ptr<const Packet> p, const Ipv4Header &h, Socket::SocketErrno e)
  {
  }
  /**
   ...
   */
  void
  Unicast2 (Ptr<Ipv4Route> route, Ptr<const Packet> packet, const Ipv4Header &header)
  {
  }
  /**
   ...
   */
  void
  Error2 (Ptr<const Packet> p, const Ipv4Header &h, Socket::SocketErrno e)
  {
  }
  virtual void
  DoRun ()
  {
    ...
    NS_TEST_EXPECT_MSG_EQ (h.GetDestination (), entry.GetIpv4Header ().GetDestination (),
                           "trivial");
    ...
    NS_TEST_EXPECT_MSG_EQ (entry.GetIpv4Header ().GetDestination (), Ipv4Address ("1.1.1.1"),
                           "trivial");
...
struct AodvRtableEntryTest : public TestCase
{
  ...
  DoRun ()
  {
    ...
    RoutingTableEntry rt (/*output device*/ dev, /*dst*/ Ipv4Address ("1.2.3.4"),
                          /*validSeqNo*/ true, /*seqNo*/ 10,
                          /*interface*/ iface, /*hop*/ 5, /*next hop*/ Ipv4Address ("3.3.3.3"),
                          /*lifetime*/ Seconds (10));
...
struct AodvRtableTest : public TestCase
{
  ...
  DoRun ()
  {
    ...
    RoutingTableEntry rt (/*output device*/ dev, /*dst*/ Ipv4Address ("1.2.3.4"),
                          /*validSeqNo*/ true, /*seqNo*/ 10,
                          /*interface*/ iface, /*hop*/ 5, /*next hop*/ Ipv4Address ("1.1.1.1"),
                          /*lifetime*/ Seconds (10));
    NS_TEST_EXPECT_MSG_EQ (rtable.AddRoute (rt), true, "trivial");
    NS_TEST_EXPECT_MSG_EQ (rtable.AddRoute (rt), false, "trivial");
    RoutingTableEntry rt2 (/*output device*/ dev, /*dst*/ Ipv4Address ("4.3.2.1"),
                           /*validSeqNo*/ false, /*seqNo*/ 0,
                           /*interface*/ iface, /*hop*/ 15, /*next hop*/ Ipv4Address ("1.1.1.1"),
                           /*lifetime*/ Seconds (1));
    ...
    NS_TEST_EXPECT_MSG_EQ (rtable.SetEntryState (Ipv4Address ("10.0.0.1"), INVALID), false,
                           "trivial");
    NS_TEST_EXPECT_MSG_EQ (rtable.SetEntryState (Ipv4Address ("1.2.3.4"), IN_SEARCH), true,
                           "trivial");
    NS_TEST_EXPECT_MSG_EQ (rtable.DeleteRoute (Ipv4Address ("5.5.5.5")), false, "trivial");
    RoutingTableEntry rt4 (/*output device*/ dev, /*dst*/ Ipv4Address ("5.5.5.5"),
                           /*validSeqNo*/ false, /*seqNo*/ 0,
                           /*interface*/ iface, /*hop*/ 15, /*next hop*/ Ipv4Address ("1.1.1.1"),
                           /*lifetime*/ Seconds (-10));
    NS_TEST_EXPECT_MSG_EQ (rtable.AddRoute (rt4), true, "trivial");
    NS_TEST_EXPECT_MSG_EQ (rtable.SetEntryState (Ipv4Address ("5.5.5.5"), INVALID), true,
                           "trivial");
