...
CobaltQueueDiscBasicEnqueueDequeue::DoRun (void)
{
  ...
  NS_TEST_EXPECT_MSG_EQ (queue->SetAttributeFailSafe ("BlueThreshold", TimeValue (Time::Max ())),
  ...
  NS_TEST_EXPECT_MSG_EQ (queue->GetStats ().GetNDroppedPackets (CobaltQueueDisc::OVERLIMIT_DROP), 0,
...

{
  ...
  NS_TEST_EXPECT_MSG_NE (st.GetNDroppedPackets (CobaltQueueDisc::OVERLIMIT_DROP), 0,
              ...
              if (currentTime < queue->GetInterval ())
                {
                  ...
                  NS_TEST_ASSERT_MSG_EQ (currentMarkCount, 0,
...

{
  ...
  NS_TEST_EXPECT_MSG_EQ (st.GetNDroppedPackets (CobaltQueueDisc::TARGET_EXCEEDED_DROP), 49,
  ...
  NS_TEST_EXPECT_MSG_EQ (st.GetNDroppedPackets (CobaltQueueDisc::TARGET_EXCEEDED_DROP), 0,
