...
TbfQueueDisc::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::TbfQueueDisc")
          ...
          .AddAttribute ("MaxSize", "The max queue size", QueueSizeValue (QueueSize ("1000p")),
                         MakeQueueSizeAccessor (&QueueDisc::SetMaxSize, &QueueDisc::GetMaxSize),
                         MakeQueueSizeChecker ())
          .AddAttribute ("Burst", "Size of the first bucket in bytes", UintegerValue (125000),
          ...
          .AddAttribute ("Mtu",
                         ...
                         MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("Rate", "Rate at which tokens enter the first bucket in bps or Bps.",
                         DataRateValue (DataRate ("125KB/s")),
                         MakeDataRateAccessor (&TbfQueueDisc::SetRate), MakeDataRateChecker ())
          .AddAttribute ("PeakRate",
                         ...
                         MakeDataRateAccessor (&TbfQueueDisc::SetPeakRate), MakeDataRateChecker ())
          .AddTraceSource ("TokensInFirstBucket", "Number of First Bucket Tokens in bytes",
                           MakeTraceSourceAccessor (&TbfQueueDisc::m_btokens),
                           "ns3::TracedValueCallback::Uint32")
          .AddTraceSource ("TokensInSecondBucket", "Number of Second Bucket Tokens in bytes",
...
TbfQueueDisc::TbfQueueDisc () : QueueDisc (QueueDiscSizePolicy::SINGLE_CHILD_QUEUE_DISC)
{
