...
struct SchInfo
{
  ...
  /// Initializer
  SchInfo () : channelNumber (SCH1), immediateAccess (false), extendedAccess (EXTENDED_ALTERNATING)
  {
  }
  /**
   * Initializer
  ...
  SchInfo (uint32_t channel, bool immediate, uint32_t channelAccess)
      : channelNumber (channel), immediateAccess (immediate), extendedAccess (channelAccess)
  {
  }
  /**
   * Initializer
