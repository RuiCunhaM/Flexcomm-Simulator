...
struct VsaInfo
{
   ...
   */
  VsaInfo (Mac48Address peer, OrganizationIdentifier identifier, uint8_t manageId,
           Ptr<Packet> vscPacket, uint32_t channel, uint8_t repeat,
...
private:
   ...
   */
  bool ReceiveVsc (Ptr<WifiMac> mac, const OrganizationIdentifier &oi, Ptr<const Packet> vsc,
                   const Address &src);
   ...
   */
  void DoSendVsa (enum VsaTransmitInterval interval, uint32_t channel, Ptr<Packet> vsc,
