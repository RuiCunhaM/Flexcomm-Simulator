...
ChannelCoordinationTestCase::ChannelCoordinationTestCase (void) : TestCase ("channel-coordination")
{
}
...
ChannelCoordinationTestCase::TestIntervalAfter (bool cchi, bool schi, bool guardi)
{
  ...
  NS_TEST_EXPECT_MSG_EQ (m_coordinator->IsCchInterval (), cchi,
                         "now is " << now
                                   << "ms "
                                      "check whether is CCH interval");
  NS_TEST_EXPECT_MSG_EQ (m_coordinator->IsSchInterval (), schi,
                         "now is " << now
                                   << "ms "
                                      "check whether is SCH interval");
  NS_TEST_EXPECT_MSG_EQ (m_coordinator->IsGuardInterval (), guardi,
                         "now is " << now
                                   << "ms "
...
ChannelCoordinationTestCase::DoRun ()
{
  ...
  NS_TEST_EXPECT_MSG_EQ (m_coordinator->GetCchInterval (), MilliSeconds (50),
                         "normally CCH interval is 50ms");
  NS_TEST_EXPECT_MSG_EQ (m_coordinator->GetSchInterval (), MilliSeconds (50),
                         "normally SCH interval is 50ms");
  NS_TEST_EXPECT_MSG_EQ (m_coordinator->GetSyncInterval (), MilliSeconds (100),
                         "normally Sync interval is 50ms");
  NS_TEST_EXPECT_MSG_EQ (m_coordinator->GetGuardInterval (), MilliSeconds (4),
                         "normally Guard interval is 50ms");
  m_coordinator->SetCchInterval (MilliSeconds (40));
  m_coordinator->SetSchInterval (MilliSeconds (60));
  NS_TEST_EXPECT_MSG_EQ (m_coordinator->IsValidConfig (), true,
                         "valid configuration of channel intervals");
  m_coordinator->SetCchInterval (MilliSeconds (40));
  m_coordinator->SetSchInterval (MilliSeconds (50));
  NS_TEST_EXPECT_MSG_EQ (m_coordinator->IsValidConfig (), false,
  ...
  m_coordinator = CreateObject<ChannelCoordinator> ();
  Simulator::Schedule (MilliSeconds (0), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       true, false, true);
  Simulator::Schedule (MilliSeconds (1), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       true, false, true);
  Simulator::Schedule (MilliSeconds (3), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       true, false, true);
  Simulator::Schedule (MilliSeconds (4), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       true, false, false);
  Simulator::Schedule (MilliSeconds (5), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       true, false, false);
  Simulator::Schedule (MilliSeconds (50), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       false, true, true);
  Simulator::Schedule (MilliSeconds (51), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       false, true, true);
  Simulator::Schedule (MilliSeconds (53), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       false, true, true);
  Simulator::Schedule (MilliSeconds (54), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       false, true, false);
  Simulator::Schedule (MilliSeconds (55), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       false, true, false);
  Simulator::Schedule (MilliSeconds (100), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       true, false, true);
  Simulator::Schedule (MilliSeconds (200), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       true, false, true);
  Simulator::Schedule (MilliSeconds (201), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       true, false, true);
  Simulator::Schedule (MilliSeconds (203), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       true, false, true);
  Simulator::Schedule (MilliSeconds (204), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       true, false, false);
  Simulator::Schedule (MilliSeconds (205), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       true, false, false);
  Simulator::Schedule (MilliSeconds (250), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       false, true, true);
  Simulator::Schedule (MilliSeconds (251), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       false, true, true);
  Simulator::Schedule (MilliSeconds (253), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       false, true, true);
  Simulator::Schedule (MilliSeconds (254), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       false, true, false);
  Simulator::Schedule (MilliSeconds (255), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       false, true, false);
  Simulator::Schedule (MilliSeconds (300), &ChannelCoordinationTestCase::TestIntervalAfter, this,
                       true, false, true);
...
ChannelRoutingTestCase::ChannelRoutingTestCase (void) : TestCase ("channel-routing")
{
}
...
ChannelRoutingTestCase::DoRun ()
{
  //  check SendX method for WSMP packets
  {
    ...
    Simulator::Schedule (Seconds (0.1), &ChannelRoutingTestCase::SendWsmp, this, true,
                         TxInfo (CCH));
    Simulator::Schedule (Seconds (0.1), &ChannelRoutingTestCase::SendWsmp, this, false,
                         TxInfo (SCH1));
    Simulator::Schedule (Seconds (0.1), &ChannelRoutingTestCase::SendWsmp, this, false,
                         TxInfo (SCH2));
    ...
    Simulator::Schedule (Seconds (0.3), &ChannelRoutingTestCase::SendWsmp, this, true,
                         TxInfo (CCH));
    Simulator::Schedule (Seconds (0.3), &ChannelRoutingTestCase::SendWsmp, this, true,
                         TxInfo (SCH1));
    Simulator::Schedule (Seconds (0.3), &ChannelRoutingTestCase::SendWsmp, this, false,
                         TxInfo (SCH2));
    Simulator::Schedule (Seconds (0.3), &ChannelRoutingTestCase::SendWsmp, this, false,
                         TxInfo (SCH3));
    Simulator::Schedule (Seconds (0.3), &ChannelRoutingTestCase::SendWsmp, this, false,
    ...
    Simulator::Schedule (Seconds (0.4), &ChannelRoutingTestCase::SendWsmp, this, false,
                         TxInfo (CCH, 8));
    // invalid tx parameters
    Simulator::Schedule (Seconds (0.4), &ChannelRoutingTestCase::SendWsmp, this, false,
                         TxInfo (CCH, 7, WifiMode ("OfdmRate6Mbps"), WIFI_PREAMBLE_LONG, 7));
    Simulator::Schedule (
        Seconds (0.4), &ChannelRoutingTestCase::SendWsmp, this, false,
        TxInfo (CCH, 7, WifiMode ("OfdmRate3MbpsBW10MHz"), WIFI_PREAMBLE_LONG, 10));
    // valid tx parameters
    Simulator::Schedule (Seconds (0.4), &ChannelRoutingTestCase::SendWsmp, this, true,
    ...
    Simulator::Schedule (Seconds (0.6), &ChannelRoutingTestCase::SendWsmp, this, true,
                         TxInfo (CCH));
    Simulator::Schedule (Seconds (0.6), &ChannelRoutingTestCase::SendWsmp, this, false,
                         TxInfo (SCH1));
    Simulator::Schedule (Seconds (0.6), &ChannelRoutingTestCase::SendWsmp, this, false,
                         TxInfo (SCH2));
...
ChannelAccessTestCase::ChannelAccessTestCase (void) : TestCase ("channel-access")
{
}
...
ChannelAccessTestCase::TestContinuousAfter (uint32_t channelNumber, bool isAccessAssigned)
{
  ...
  NS_TEST_EXPECT_MSG_EQ (result, isAccessAssigned,
...
bool
ChannelAccessTestCase::Receive (Ptr<NetDevice> dev, Ptr<const Packet> pkt, uint16_t mode,
...
ChannelAccessTestCase::DoRun ()
{
  // test ContinuousAccess in the sender side
  {
    ...
    Simulator::Schedule (Seconds (2), &ChannelAccessTestCase::TestContinuousAfter, this, SCH1,
                         false);
    Simulator::Schedule (Seconds (2.01), &ChannelAccessTestCase::TestContinuousAfter, this, SCH1,
                         false);
    Simulator::Schedule (Seconds (2.049), &ChannelAccessTestCase::TestContinuousAfter, this, SCH1,
                         false);
    Simulator::Schedule (Seconds (2.05), &ChannelAccessTestCase::TestContinuousAfter, this, SCH1,
                         false);
    Simulator::Schedule (Seconds (2.051), &ChannelAccessTestCase::TestContinuousAfter, this, SCH1,
                         true);
    Simulator::Schedule (Seconds (2.99), &ChannelAccessTestCase::TestContinuousAfter, this, SCH1,
                         true);
  ...
  // test ExtendedAccess in the sender side
  {
    ...
    Simulator::Schedule (Seconds (2.01), &ChannelAccessTestCase::TestExtendedAfter, this, SCH1,
                         false);
    Simulator::Schedule (Seconds (2.049), &ChannelAccessTestCase::TestExtendedAfter, this, SCH1,
                         false);
    Simulator::Schedule (Seconds (2.05), &ChannelAccessTestCase::TestExtendedAfter, this, SCH1,
                         false);
    Simulator::Schedule (Seconds (2.051), &ChannelAccessTestCase::TestExtendedAfter, this, SCH1,
                         true);
    Simulator::Schedule (Seconds (2.99), &ChannelAccessTestCase::TestExtendedAfter, this, SCH1,
                         true);
    ...
    Simulator::Schedule (Seconds (3.1), &ChannelAccessTestCase::TestExtendedAfter, this, SCH1,
                         true);
    Simulator::Schedule (Seconds (3.2), &ChannelAccessTestCase::TestExtendedAfter, this, SCH1,
                         false);
    Simulator::Schedule (Seconds (3.3), &ChannelAccessTestCase::TestExtendedAfter, this, SCH1,
                         false);
    ...
    Simulator::Schedule (Seconds (5.1), &ChannelAccessTestCase::TestExtendedAfter, this, SCH2,
                         false);
    Simulator::Schedule (Seconds (5.2), &ChannelAccessTestCase::TestExtendedAfter, this, SCH2,
                         false);
  ...
  // test AlternatingAccess in the sender side
  {
    ...
    Simulator::Schedule (Seconds (2), &ChannelAccessTestCase::TestAlternatingAfter, this, SCH1,
                         true);
    Simulator::Schedule (Seconds (2.01), &ChannelAccessTestCase::TestAlternatingAfter, this, SCH1,
                         true);
    Simulator::Schedule (Seconds (2.049), &ChannelAccessTestCase::TestAlternatingAfter, this, SCH1,
                         true);
    Simulator::Schedule (Seconds (2.05), &ChannelAccessTestCase::TestAlternatingAfter, this, SCH1,
                         true);
    Simulator::Schedule (Seconds (2.051), &ChannelAccessTestCase::TestAlternatingAfter, this, SCH1,
                         true);
    Simulator::Schedule (Seconds (2.99), &ChannelAccessTestCase::TestAlternatingAfter, this, SCH1,
                         true);
...
AnnexC_TestCase::AnnexC_TestCase (void) : TestCase ("annex-c")
{
}
...
bool
AnnexC_TestCase::Receive (Ptr<NetDevice> dev, Ptr<const Packet> pkt, uint16_t mode,
                          const Address &sender)
{
  uint8_t *data = new uint8_t[pkt->GetSize ()];
  pkt->CopyData (data, pkt->GetSize ());
  ...
  if (seq == 1)
    {
      NS_TEST_EXPECT_MSG_GT (duration, ChannelCoordinator::GetDefaultSchInterval (),
                             "fail to test Annex C when packet sequence is " << seq);
    }
  else if (seq == 2)
    {
      NS_TEST_EXPECT_MSG_LT (duration, ChannelCoordinator::GetDefaultSchInterval (),
                             "fail to test Annex C when packet sequence is " << seq);
    }
  else if (seq == 3)
    {
      NS_TEST_EXPECT_MSG_GT (duration, ChannelCoordinator::GetDefaultCchInterval (),
                             "fail to test Annex C when packet sequence is " << seq);
    }
  else if (seq == 4)
    {
      NS_TEST_EXPECT_MSG_LT (duration, ChannelCoordinator::GetDefaultCchInterval (),
                             "fail to test Annex C when packet sequence is " << seq);
    }
  return true;
}
...
WaveMacTestSuite::WaveMacTestSuite () : TestSuite ("wave-mac-extension", UNIT)
{
