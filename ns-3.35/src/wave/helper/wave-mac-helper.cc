...
void
NqosWaveMacHelper::SetType (std::string type, std::string n0, const AttributeValue &v0,
                            ...
                            std::string n7, const AttributeValue &v7, std::string n8,
                            ...
                            std::string n10, const AttributeValue &v10)
{
  ...
  WifiMacHelper::SetType ("ns3::OcbWifiMac", n0, v0, n1, v1, n2, v2, n3, v3, n4, v4, n5, v5, n6, v6,
                          n7, v7, n8, v8, n9, v9, n10, v10);
}
...
void
QosWaveMacHelper::SetType (std::string type, std::string n0, const AttributeValue &v0,
                           std::string n1, const AttributeValue &v1, std::string n2,
                           const AttributeValue &v2, std::string n3, const AttributeValue &v3,
                           std::string n4, const AttributeValue &v4, std::string n5,
                           const AttributeValue &v5, std::string n6, const AttributeValue &v6,
