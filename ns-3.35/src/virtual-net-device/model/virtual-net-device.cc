...
bool
VirtualNetDevice::Receive (Ptr<Packet> packet, uint16_t protocol, const Address &source,
...
bool
VirtualNetDevice::SendFrom (Ptr<Packet> packet, const Address &source, const Address &dest,
