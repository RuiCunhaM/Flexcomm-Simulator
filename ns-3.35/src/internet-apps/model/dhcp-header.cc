...
Ipv4Address
DhcpHeader::GetYiaddr (void) const
{
  return m_yiAddr;
}
...
Ipv4Address
DhcpHeader::GetDhcps (void) const
{
  return m_dhcps;
}
...
Ipv4Address
DhcpHeader::GetRouter (void) const
{
  return m_route;
}
...
uint32_t
DhcpHeader::GetLease (void) const
{
  return m_lease;
}
...
uint32_t
DhcpHeader::GetRenew (void) const
{
  return m_renew;
}
...
uint32_t
DhcpHeader::GetRebind (void) const
{
  return m_rebind;
}
...
uint32_t
DhcpHeader::GetSerializedSize (void) const
{
  return m_len;
}

TypeId
DhcpHeader::GetTypeId (void)
{
...
TypeId
DhcpHeader::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
