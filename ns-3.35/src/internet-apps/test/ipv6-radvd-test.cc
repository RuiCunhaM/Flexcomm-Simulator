...
private:
   ...
   */
  void CheckAddresses (Ptr<NetDevice> n0Dev, Ptr<NetDevice> r0Dev, Ptr<NetDevice> r1Dev,
                       Ptr<NetDevice> n1Dev);
  /**
   ...
   * \param n1Dev node 1 device
   */
  void CheckRouting (Ptr<NetDevice> n0Dev, Ptr<NetDevice> r0Dev, Ptr<NetDevice> r1Dev,
                     Ptr<NetDevice> n1Dev);
...
void
RadvdTestCase::CheckAddresses (Ptr<NetDevice> n0Dev, Ptr<NetDevice> r0Dev, Ptr<NetDevice> r1Dev,
                               Ptr<NetDevice> n1Dev)
{
...
void
RadvdTestCase::CheckRouting (Ptr<NetDevice> n0Dev, Ptr<NetDevice> r0Dev, Ptr<NetDevice> r1Dev,
                             Ptr<NetDevice> n1Dev)
{
  Ptr<Ipv6L3Protocol> ipv6;
...
RadvdTestCase::DoRun (void)
{
  ...
  Simulator::Schedule (Seconds (2), &RadvdTestCase::CheckAddresses, this, d1.Get (0), d1.Get (1),
                       d2.Get (0), d2.Get (1));
  Simulator::Schedule (Seconds (3), &RadvdTestCase::CheckRouting, this, d1.Get (0), d1.Get (1),
                       d2.Get (0), d2.Get (1));
