...
main (int argc, char *argv[])
{
  ...
  PointToPointDumbbellHelper d (nLeftLeaf, pointToPointLeaf, nRightLeaf, pointToPointLeaf,
                                pointToPointRouter);
  ...
  pAnim->SetBackgroundImage ("/Users/john/ns3/netanim-3.105/ns-3-background.png", 0, 0, 0.2, 0.2,
                             0.1);
