...
RawTextConfigSave::RawTextConfigSave () : m_os (0)
{
...
RawTextConfigLoad::RawTextConfigLoad () : m_is (0)
{
  NS_LOG_FUNCTION (this);
}
...
bool
RawTextConfigLoad::ParseLine (const std::string &line, std::string &type, std::string &name,
                              std::string &value)
{
