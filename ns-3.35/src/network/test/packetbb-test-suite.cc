...
PbbTestSuite::PbbTestSuite () : TestSuite ("packetbb-test-suite", UNIT)
{
   ...
   */
  {
    ...
    uint8_t buffer[] = {0x0c, 0x00, 0x06, 0x00, 0x0a, 0x01, 0x00, 0x02,
  ...
  */
  {
    ...
    uint8_t buffer[] = {0x0c, 0x00, 0x08, 0x00, 0x02, 0x01, 0x00,
  ...
  */
  {
    ...
    uint8_t buffer[] = {0x0c, 0x00, 0x09, 0x00, 0x02, 0x01, 0x00, 0x01,
