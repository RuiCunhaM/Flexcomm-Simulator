  ...
  static TypeId tid =
      TypeId ("ns3::LiIonEnergySource")
          ...
          .AddAttribute (
              ...
              MakeDoubleAccessor (&LiIonEnergySource::m_lowBatteryTh), MakeDoubleChecker<double> ())
          ...
          .AddAttribute ("NominalCellVoltage", "Nominal voltage of the cell.",
                         ...
                         MakeDoubleChecker<double> ())
          .AddAttribute ("ExpCellVoltage", "Cell voltage at the end of the exponential zone.",
                         DoubleValue (3.6), // in Volts
          ...
          .AddAttribute ("RatedCapacity", "Rated capacity of the cell.",
                         ...
                         MakeDoubleChecker<double> ())
          .AddAttribute ("NomCapacity", "Cell capacity at the end of the nominal zone.",
                         DoubleValue (1.1), // in Ah
                         MakeDoubleAccessor (&LiIonEnergySource::m_qNom),
                         MakeDoubleChecker<double> ())
          .AddAttribute ("ExpCapacity", "Cell Capacity at the end of the exponential zone.",
                         DoubleValue (1.2), // in Ah
                         MakeDoubleAccessor (&LiIonEnergySource::m_qExp),
                         MakeDoubleChecker<double> ())
          .AddAttribute ("InternalResistance", "Internal resistance of the cell",
                         DoubleValue (0.083), // in Ohms
                         MakeDoubleAccessor (&LiIonEnergySource::m_internalResistance),
                         MakeDoubleChecker<double> ())
          .AddAttribute ("TypCurrent", "Typical discharge current used to fit the curves",
          ...
          .AddAttribute (
              ...
              MakeDoubleAccessor (&LiIonEnergySource::m_minVoltTh), MakeDoubleChecker<double> ())
          .AddAttribute ("PeriodicEnergyUpdateInterval",
                         ...
                         MakeTimeChecker ())
          .AddTraceSource ("RemainingEnergy", "Remaining energy at BasicEnergySource.",
                           MakeTraceSourceAccessor (&LiIonEnergySource::m_remainingEnergyJ),
                           "ns3::TracedValueCallback::Double");
  return tid;
}

LiIonEnergySource::LiIonEnergySource () : m_drainedCapacity (0.0), m_lastUpdateTime (Seconds (0.0))
{
