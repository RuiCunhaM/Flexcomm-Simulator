  ...
  static TypeId tid =
      TypeId ("ns3::BasicEnergyHarvester")
          ...
          .AddAttribute ("PeriodicHarvestedPowerUpdateInterval",
                         "Time between two consecutive periodic updates of the harvested power. By "
                         "default, the value is updated every 1 s",
          ...
          .AddTraceSource ("HarvestedPower", "Harvested power by the BasicEnergyHarvester.",
                           MakeTraceSourceAccessor (&BasicEnergyHarvester::m_harvestedPower),
                           "ns3::TracedValueCallback::Double")
          .AddTraceSource ("TotalEnergyHarvested", "Total energy harvested by the harvester.",
...
BasicEnergyHarvester::UpdateHarvestedPower (void)
{
  ...
  m_energyHarvestingUpdateEvent = Simulator::Schedule (
      m_harvestedPowerUpdateInterval, &BasicEnergyHarvester::UpdateHarvestedPower, this);
}
