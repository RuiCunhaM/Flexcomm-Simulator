...
TopologyReader::Link::Link (Ptr<Node> fromPtr, const std::string &fromName, Ptr<Node> toPtr,
...
Ptr<Node>
TopologyReader::Link::GetFromNode (void) const
{
  return m_fromPtr;
}
