...
PeerLinkOpenStart::PeerLinkOpenStart ()
    : m_capability (0), m_rates (SupportedRates ()), m_meshId (), m_config (IeConfiguration ())
{
}
void
...
PeerLinkConfirmStart::PeerLinkConfirmStart ()
    : m_capability (0), m_aid (0), m_rates (SupportedRates ()), m_config (IeConfiguration ())
{
}
void
...
{
  return ((a.m_capability == b.m_capability) && (a.m_aid == b.m_aid) && (a.m_config == b.m_config));
}
} // namespace dot11s
} // namespace ns3
