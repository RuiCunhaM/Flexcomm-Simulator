...
LrWpanEdTestCase::LrWpanEdTestCase () : TestCase ("Test the 802.15.4 energie detection")
{
...
LrWpanEdTestSuite::LrWpanEdTestSuite () : TestSuite ("lr-wpan-energy-detection", UNIT)
{
