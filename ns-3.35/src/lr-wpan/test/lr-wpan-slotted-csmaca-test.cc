...
private:
   ...
   */
  static void TransEndIndication (LrWpanSlottedCsmacaTestCase *testcase, Ptr<LrWpanNetDevice> dev,
  ...
  static void DataIndicationCoordinator (LrWpanSlottedCsmacaTestCase *testcase,
                                         Ptr<LrWpanNetDevice> dev, McpsDataIndicationParams params,
                                         Ptr<Packet> p);
  /**
   ...
   */
  static void StartConfirm (LrWpanSlottedCsmacaTestCase *testcase, Ptr<LrWpanNetDevice> dev,
  ...
  static void IncomingSuperframeStatus (LrWpanSlottedCsmacaTestCase *testcase,
                                        Ptr<LrWpanNetDevice> dev, SuperframeStatus oldValue,
   ...
   */
  static void TransactionCost (LrWpanSlottedCsmacaTestCase *testcase, Ptr<LrWpanNetDevice> dev,
                               uint32_t trans);
  ...
  Time
      m_apBoundary; //!< Indicates the time after the calculation of the transaction cost (A boundary of an Active Period in the CAP)
...
LrWpanSlottedCsmacaTestCase::StartConfirm (LrWpanSlottedCsmacaTestCase *testcase,
                                           Ptr<LrWpanNetDevice> dev, MlmeStartConfirmParams params)
{
...
LrWpanSlottedCsmacaTestCase::DoRun ()
{
  ...
  Simulator::ScheduleWithContext (1, Seconds (2.93), &LrWpanMac::McpsDataRequest, dev1->GetMac (),
                                  params2, p1);
  ...
  NS_TEST_EXPECT_MSG_EQ (m_sentTime, (m_apBoundary + transactionTime),
