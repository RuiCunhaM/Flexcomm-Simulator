...
private:
   ...
   */
  static void DataConfirm (LrWpanDataIfsTestCase *testcase, Ptr<LrWpanNetDevice> dev,
   ...
   * \param p packet
   */
  static void DataReceivedDev0 (LrWpanDataIfsTestCase *testcase, Ptr<LrWpanNetDevice> dev,
                                Ptr<const Packet> p);
   ...
   * \param p packet
   */
  static void PhyDataRxStart (LrWpanDataIfsTestCase *testcase, Ptr<LrWpanNetDevice> dev,
                              Ptr<const Packet> p);
   ...
   * \param p packet
   */
  static void DataReceivedDev1 (LrWpanDataIfsTestCase *testcase, Ptr<LrWpanNetDevice> dev,
                                Ptr<const Packet>);
...
LrWpanDataIfsTestCase::LrWpanDataIfsTestCase () : TestCase ("Lrwpan: IFS tests")
{
}
...
void
LrWpanDataIfsTestCase::DataConfirm (LrWpanDataIfsTestCase *testcase, Ptr<LrWpanNetDevice> dev,
                                    McpsDataConfirmParams params)
{
...
void
LrWpanDataIfsTestCase::DataReceivedDev0 (LrWpanDataIfsTestCase *testcase, Ptr<LrWpanNetDevice> dev,
                                         Ptr<const Packet> p)
{
...
void
LrWpanDataIfsTestCase::PhyDataRxStart (LrWpanDataIfsTestCase *testcase, Ptr<LrWpanNetDevice> dev,
                                       Ptr<const Packet>)
{
...
void
LrWpanDataIfsTestCase::DataReceivedDev1 (LrWpanDataIfsTestCase *testcase, Ptr<LrWpanNetDevice> dev,
                                         Ptr<const Packet> p)
{
...
void
LrWpanDataIfsTestCase::IfsEnd (LrWpanDataIfsTestCase *testcase, Ptr<LrWpanNetDevice> dev,
                               Time IfsTime)
{
...
LrWpanDataIfsTestCase::DoRun ()
{
  ...
  dev0->GetMac ()->TraceConnectWithoutContext (
      "MacRx", MakeBoundCallback (&LrWpanDataIfsTestCase::DataReceivedDev0, this, dev0));
  dev0->GetPhy ()->TraceConnectWithoutContext (
      "PhyRxBegin", MakeBoundCallback (&LrWpanDataIfsTestCase::PhyDataRxStart, this, dev0));
  dev1->GetMac ()->TraceConnectWithoutContext (
      "MacRx", MakeBoundCallback (&LrWpanDataIfsTestCase::DataReceivedDev1, this, dev1));
  ...
  Simulator::ScheduleWithContext (1, Seconds (0.0), &LrWpanMac::McpsDataRequest, dev0->GetMac (),
                                  params, p0);
  ...
  NS_TEST_EXPECT_MSG_EQ (ifsSize, Time (MicroSeconds (192)),
  ...
  NS_TEST_ASSERT_MSG_GT (m_endIfs, m_phyStartRx,
