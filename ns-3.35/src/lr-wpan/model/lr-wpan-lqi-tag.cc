...
LrWpanLqiTag::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::LrWpanLqiTag")
          ...
          .AddAttribute ("Lqi", "The lqi of the last packet received", IntegerValue (0),
                         MakeIntegerAccessor (&LrWpanLqiTag::Get), MakeIntegerChecker<uint8_t> ());
  return tid;
}
...
LrWpanLqiTag::LrWpanLqiTag (void) : m_lqi (0)
{
}
