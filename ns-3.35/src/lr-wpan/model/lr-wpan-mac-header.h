...
private:
  ...
  uint8_t
      m_fctrlFrmType; //!< Frame Control field Bit 0-2    = 0 - Beacon, 1 - Data, 2 - Ack, 3 - Command
  uint8_t
      m_fctrlSecU; //!< Frame Control field Bit 3      = 0 - no AuxSecHdr ,  1 - security enabled AuxSecHdr present
  uint8_t m_fctrlFrmPending; //!< Frame Control field Bit 4
  uint8_t m_fctrlAckReq; //!< Frame Control field Bit 5
  uint8_t
      m_fctrlPanIdComp; //!< Frame Control field Bit 6      = 0 - no compression, 1 - using only DstPanId for both Src and DstPanId
  uint8_t m_fctrlReserved; //!< Frame Control field Bit 7-9
  uint8_t
      m_fctrlDstAddrMode; //!< Frame Control field Bit 10-11  = 0 - No DstAddr, 2 - ShtDstAddr, 3 - ExtDstAddr
  uint8_t m_fctrlFrmVer; //!< Frame Control field Bit 12-13
  uint8_t
      m_fctrlSrcAddrMode; //!< Frame Control field Bit 14-15  = 0 - No SrcAddr, 2 - ShtSrcAddr, 3 - ExtSrcAddr
  ...
  uint8_t
      m_secctrlKeyIdMode; //!< Auxiliary security header - Security Control field - Bit 3-4 will indicate size of Key Id
