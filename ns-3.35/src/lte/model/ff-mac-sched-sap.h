...
public:
   ...
   */
  virtual void
  SchedUlNoiseInterferenceReq (const struct SchedUlNoiseInterferenceReqParameters &params) = 0;
...
public:
  ...
  virtual void
  SchedUlNoiseInterferenceReq (const struct SchedUlNoiseInterferenceReqParameters &params);
...
template <class C>
MemberSchedSapProvider<C>::MemberSchedSapProvider (C *scheduler) : m_scheduler (scheduler)
{
}
