...
TtaFfMacScheduler::TtaFfMacScheduler () : m_cschedSapUser (0), m_schedSapUser (0), m_nextRntiUl (0)
{
  ...
  static TypeId tid =
      TypeId ("ns3::TtaFfMacScheduler")
          ...
          .AddAttribute (
              ...
              UintegerValue (1000), MakeUintegerAccessor (&TtaFfMacScheduler::m_cqiTimersThreshold),
              MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("HarqEnabled", "Activate/Deactivate the HARQ [by default is active].",
                         BooleanValue (true), MakeBooleanAccessor (&TtaFfMacScheduler::m_harqOn),
                         MakeBooleanChecker ())
          .AddAttribute ("UlGrantMcs", "The MCS of the UL grant, must be [0..15] (default 0)",
                         UintegerValue (0), MakeUintegerAccessor (&TtaFfMacScheduler::m_ulGrantMcs),
