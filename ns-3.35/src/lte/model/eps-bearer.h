...
private:
  ...
  /**
    ...
    */
  typedef std::unordered_map<Qci, std::tuple<bool, uint8_t, uint16_t, double, uint32_t, uint32_t>,
                             QciHash>
   ...
   */
  static uint32_t
  IsGbr (const BearerRequirementsMap &map, Qci qci)
  {
   ...
   */
  static uint8_t
  GetPriority (const BearerRequirementsMap &map, Qci qci)
  {
   ...
   */
  static uint16_t
  GetPacketDelayBudgetMs (const BearerRequirementsMap &map, Qci qci)
  {
   ...
   */
  static double
  GetPacketErrorLossRate (const BearerRequirementsMap &map, Qci qci)
  {
   ...
   */
  static uint32_t
  GetMaxDataBurst (const BearerRequirementsMap &map, Qci qci)
  {
   ...
   */
  static uint32_t
  GetAvgWindow (const BearerRequirementsMap &map, Qci qci)
  {
