...
public:
   ...
   * 
   */
  void SetupDataRadioBearer (EpsBearer bearer, uint8_t bearerId, uint32_t gtpTeid,
...
public:
   ...
   * \param [in] cause
   */
  typedef void (*TimerExpiryTracedCallback) (const uint64_t imsi, const uint16_t rnti,
                                             const uint16_t cellId, const std::string cause);
