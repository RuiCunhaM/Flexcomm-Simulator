  ...
  static TypeId tid =
      TypeId ("ns3::ComponentCarrier")
          ...
          .AddAttribute (
              ...
              UintegerValue (100),
              MakeUintegerAccessor (&ComponentCarrier::SetDlEarfcn, &ComponentCarrier::GetDlEarfcn),
          ...
          .AddAttribute (
              ...
              "as per 3GPP 36.101 Section 5.7.3. ",
              UintegerValue (18100),
              MakeUintegerAccessor (&ComponentCarrier::SetUlEarfcn, &ComponentCarrier::GetUlEarfcn),
...
TypeId
ComponentCarrierBaseStation::GetTypeId (void)
{
