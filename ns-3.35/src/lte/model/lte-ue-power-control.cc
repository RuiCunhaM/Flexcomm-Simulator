  ...
  static TypeId tid =
      TypeId ("ns3::LteUePowerControl")
          ...
          .AddAttribute (
              ...
              BooleanValue (true), MakeBooleanAccessor (&LteUePowerControl::m_closedLoop),
              MakeBooleanChecker ())
          ...
          .AddAttribute ("Pcmax",
                         ...
                         DoubleValue (23.0), MakeDoubleAccessor (&LteUePowerControl::m_Pcmax),
                         MakeDoubleChecker<double> ())
          .AddAttribute ("Pcmin",
                         "Min Transmission power in dBm, Default value -40 dBm"
                         "TS36.101 section 6.2.3",
                         DoubleValue (-40), MakeDoubleAccessor (&LteUePowerControl::m_Pcmin),
                         MakeDoubleChecker<double> ())
          .AddAttribute (
              "PoNominalPusch", "P_O_NOMINAL_PUSCH   INT (-126 ... 24), Default value -80",
              IntegerValue (-80), MakeIntegerAccessor (&LteUePowerControl::SetPoNominalPusch),
              MakeIntegerChecker<int16_t> ())
          .AddAttribute ("PoUePusch", "P_O_UE_PUSCH   INT(-8...7), Default value 0",
                         IntegerValue (0), MakeIntegerAccessor (&LteUePowerControl::SetPoUePusch),
                         MakeIntegerChecker<int16_t> ())
          .AddAttribute ("PsrsOffset", "P_SRS_OFFSET   INT(0...15), Default value 7",
                         IntegerValue (7), MakeIntegerAccessor (&LteUePowerControl::m_PsrsOffset),
                         MakeIntegerChecker<int16_t> ())
          .AddTraceSource ("ReportPuschTxPower", "Report PUSCH TxPower in dBm",
                           MakeTraceSourceAccessor (&LteUePowerControl::m_reportPuschTxPower),
                           "ns3::LteUePowerControl::TxPowerTracedCallback")
          .AddTraceSource ("ReportPucchTxPower", "Report PUCCH TxPower in dBm",
                           MakeTraceSourceAccessor (&LteUePowerControl::m_reportPucchTxPower),
                           "ns3::LteUePowerControl::TxPowerTracedCallback")
          .AddTraceSource ("ReportSrsTxPower", "Report SRS TxPower in dBm",
