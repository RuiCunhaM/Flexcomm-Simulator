...
EpcPgwApplication::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::EpcPgwApplication")
          .SetParent<Object> ()
          .SetGroupName ("Lte")
          .AddTraceSource ("RxFromTun", "Receive data packets from internet in Tunnel NetDevice",
                           MakeTraceSourceAccessor (&EpcPgwApplication::m_rxTunPktTrace),
                           "ns3::EpcPgwApplication::RxTracedCallback")
          .AddTraceSource ("RxFromS1u", "Receive data packets from S5 Socket",
...
bool
EpcPgwApplication::RecvFromTunDevice (Ptr<Packet> packet, const Address &source,
...
EpcPgwApplication::SendToTunDevice (Ptr<Packet> packet, uint32_t teid)
{
  ...
  m_tunDevice->Receive (packet, protocol, m_tunDevice->GetAddress (), m_tunDevice->GetAddress (),
