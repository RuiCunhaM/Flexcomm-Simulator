  ...
  static TypeId tid =
      TypeId ("ns3::LteUeRrc")
          ...
          .AddAttribute (
              ...
              MakeUintegerAccessor (&LteUeRrc::m_n310), MakeUintegerChecker<uint8_t> (1, 20))
          .AddAttribute (
              "N311",
              ...
              MakeUintegerAccessor (&LteUeRrc::m_n311), MakeUintegerChecker<uint8_t> (1, 10))
          ...
          .AddTraceSource ("Srb1Created", "trace fired after SRB1 is created",
          ...
          .AddTraceSource ("RadioLinkFailure", "trace fired upon failure of radio link",
    ...
    LteRrcSap::NonCriticalExtensionConfiguration nonCec)
{
  ...
  for (std::list<LteRrcSap::SCellToAddMod>::iterator it = nonCec.sCellsToAddModList.begin ();
       it != nonCec.sCellsToAddModList.end (); it++)
    {
      ...
      uint16_t srsIndex = scell.radioResourceConfigDedicateSCell.physicalConfigDedicatedSCell
