...
protected:
  ...
  DoSetupDataRadioBearer (EpsBearer bearer, uint8_t bearerId, uint16_t rnti, uint8_t lcid,
...
protected:
  // Inherited methods
  virtual void
  DoReportBufferStatus (LteMacSapProvider::ReportBufferStatusParameters params) override;
