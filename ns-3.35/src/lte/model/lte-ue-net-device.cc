...
LteUeNetDevice::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::LteUeNetDevice")
          ...
          .AddAttribute ("LteUeRrc", "The RRC associated to this UeNetDevice", PointerValue (),
          ...
          .AddAttribute ("ComponentCarrierMapUe", "List of all component Carrier.",
                         ObjectMapValue (), MakeObjectMapAccessor (&LteUeNetDevice::m_ccMap),
...
LteUeNetDevice::LteUeNetDevice (void) : m_isConstructed (false)
{
