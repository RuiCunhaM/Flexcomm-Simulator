...
struct tdtbfqsFlowPerf_t
{
  ...
  uint32_t
      burstCredit; ///< the maximum number of tokens connection i can borrow from the bank each time
  int debtLimit; ///< counter threshold that the flow cannot further borrow tokens from bank
  uint32_t
      creditableThreshold; ///< the flow cannot borrow token from bank until the number of token it has deposited to bank reaches this threshold
};
...
private:
   ...
   */
  void
  DoCschedUeConfigReq (const struct FfMacCschedSapProvider::CschedUeConfigReqParameters &params);
   ...
   */
  void
  DoCschedLcConfigReq (const struct FfMacCschedSapProvider::CschedLcConfigReqParameters &params);
   ...
   */
  void
  DoCschedLcReleaseReq (const struct FfMacCschedSapProvider::CschedLcReleaseReqParameters &params);
   ...
   */
  void
  DoCschedUeReleaseReq (const struct FfMacCschedSapProvider::CschedUeReleaseReqParameters &params);
   ...
   */
  void
  DoSchedDlRlcBufferReq (const struct FfMacSchedSapProvider::SchedDlRlcBufferReqParameters &params);
   ...
   */
  void
  DoSchedDlMacBufferReq (const struct FfMacSchedSapProvider::SchedDlMacBufferReqParameters &params);
   ...
   */
  void
  DoSchedDlTriggerReq (const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters &params);
   ...
   */
  void
  DoSchedDlRachInfoReq (const struct FfMacSchedSapProvider::SchedDlRachInfoReqParameters &params);
   ...
   */
  void
  DoSchedDlCqiInfoReq (const struct FfMacSchedSapProvider::SchedDlCqiInfoReqParameters &params);
   ...
   */
  void
  DoSchedUlTriggerReq (const struct FfMacSchedSapProvider::SchedUlTriggerReqParameters &params);
   ...
   */
  void
  DoSchedUlCqiInfoReq (const struct FfMacSchedSapProvider::SchedUlCqiInfoReqParameters &params);
