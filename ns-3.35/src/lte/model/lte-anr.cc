...
LteAnr::LteAnr (uint16_t servingCellId)
    : m_anrSapUser (0), m_threshold (0), m_measId (0), m_servingCellId (servingCellId)
{
  ...
  static TypeId tid =
      TypeId ("ns3::LteAnr")
          ...
          .AddAttribute ("Threshold",
                         ...
                         UintegerValue (0), MakeUintegerAccessor (&LteAnr::m_threshold),
                         MakeUintegerChecker<uint8_t> (
                             0, 34)) // RSRQ range is [0..34] as per Section 9.1.7 of 3GPP TS 36.133
      ;
  return tid;
}
