...
LteUePhy::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::LteUePhy")
          ...
          .AddTraceSource ("ReportPowerSpectralDensity", "Power Spectral Density data.",
          ...
          .AddAttribute (
              ...
              MakeUintegerChecker<uint16_t> ())
          .AddAttribute ("EnableRlfDetection", "If true, RLF detection will be enabled.",
                         BooleanValue (true), MakeBooleanAccessor (&LteUePhy::m_enableRlfDetection),
                         MakeBooleanChecker ());
  return tid;
}
...
LteUePhy::CreateTxPowerSpectralDensity ()
{
  ...
  Ptr<SpectrumValue> psd = psdHelper.CreateUlTxPowerSpectralDensity (
