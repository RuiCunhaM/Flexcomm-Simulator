    ...
    : TestSuite ("lte-radio-link-failure", SYSTEM)
{
  ...
  //
  AddTestCase (new LteRadioLinkFailureTestCase (1, 1, Seconds (2), true, uePositionList,
                                                enbPositionList, ueJumpAwayPosition,
                                                checkConnectedList),
               TestCase::QUICK);

  // One eNB: Real RRC PROTOCOL
  AddTestCase (new LteRadioLinkFailureTestCase (1, 1, Seconds (2), false, uePositionList,
                                                enbPositionList, ueJumpAwayPosition,
                                                checkConnectedList),
               TestCase::QUICK);
  ...
  AddTestCase (new LteRadioLinkFailureTestCase (2, 1, Seconds (2), true, uePositionList,
                                                enbPositionList, ueJumpAwayPosition,
                                                checkConnectedList),
               TestCase::QUICK);

  // Two eNBs: Ideal RRC PROTOCOL
  AddTestCase (new LteRadioLinkFailureTestCase (2, 1, Seconds (2), false, uePositionList,
                                                enbPositionList, ueJumpAwayPosition,
                                                checkConnectedList),
               TestCase::QUICK);
...
LteRadioLinkFailureTestCase::LteRadioLinkFailureTestCase (uint32_t numEnbs, uint32_t numUes,
                                                          Time simTime, bool isIdealRrc,
                                                          std::vector<Vector> uePositionList,
                                                          std::vector<Vector> enbPositionList,
                                                          Vector ueJumpAwayPosition,
                                                          std::vector<Time> checkConnectedList)
  ...
  for (uint32_t u = 0; u < m_numUes; ++u)
    {
      Simulator::Schedule (m_checkConnectedList.at (u),
                           &LteRadioLinkFailureTestCase::CheckConnected, this, ueDevs.Get (u),
                           enbDevs);
    }

  Simulator::Schedule (Seconds (0.4), &LteRadioLinkFailureTestCase::JumpAway, this,
...
void
LteRadioLinkFailureTestCase::UeStateTransitionCallback (std::string context, uint64_t imsi,
...
void
LteRadioLinkFailureTestCase::ConnectionEstablishedEnbCallback (std::string context, uint64_t imsi,
                                                               uint16_t cellId, uint16_t rnti)
{
...
void
LteRadioLinkFailureTestCase::ConnectionEstablishedUeCallback (std::string context, uint64_t imsi,
                                                              uint16_t cellId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this << imsi << cellId << rnti);
...
void
LteRadioLinkFailureTestCase::PhySyncDetectionCallback (std::string context, uint64_t imsi,
...
void
LteRadioLinkFailureTestCase::RadioLinkFailureCallback (std::string context, uint64_t imsi,
                                                       uint16_t cellId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this << imsi << cellId << rnti);
