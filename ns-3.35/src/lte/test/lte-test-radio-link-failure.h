...
public:
  ...
  LteRadioLinkFailureTestCase (uint32_t numEnbs, uint32_t numUes, Time simTime, bool isIdealRrc,
                               ...
                               std::vector<Vector> enbPositionList, Vector ueJumpAwayPosition,
...
private:
   ...
   */
  void UeStateTransitionCallback (std::string context, uint64_t imsi, uint16_t cellId,
   ...
   * \param rnti the RNTI
   */
  void ConnectionEstablishedUeCallback (std::string context, uint64_t imsi, uint16_t cellId,
                                        uint16_t rnti);
   ...
   * \param rnti the RNTI
   */
  void ConnectionEstablishedEnbCallback (std::string context, uint64_t imsi, uint16_t cellId,
                                         uint16_t rnti);
   ...
   * \param rnti the RNTI
   */
  void ConnectionReleaseAtEnbCallback (std::string context, uint64_t imsi, uint16_t cellId,
                                       uint16_t rnti);
   ...
   */
  void PhySyncDetectionCallback (std::string context, uint64_t imsi, uint16_t rnti, uint16_t cellId,
   ...
   * \param cellId the cell ID
   */
  void RadioLinkFailureCallback (std::string context, uint64_t imsi, uint16_t cellId,
                                 uint16_t rnti);
