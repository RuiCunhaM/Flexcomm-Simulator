...
LteFrTestCase::LteFrTestCase (std::string name, uint32_t userNum, uint16_t dlBandwidth,
...
LteStrictFrTestCase::LteStrictFrTestCase (
    std::string name, uint32_t userNum, std::string schedulerType, uint16_t dlBandwidth,
    uint16_t ulBandwidth, uint16_t dlCommonSubBandwidth, uint8_t dlEdgeSubBandOffset,
    uint16_t dlEdgeSubBandwidth, uint16_t ulCommonSubBandwidth, uint8_t ulEdgeSubBandOffset,
    uint16_t ulEdgeSubBandwidth, std::vector<bool> availableDlRb, std::vector<bool> availableUlRb)
    : LteFrTestCase (name, userNum, dlBandwidth, ulBandwidth, availableDlRb, availableUlRb),
      m_schedulerType (schedulerType),
