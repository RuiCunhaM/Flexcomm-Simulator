...
LteCellSelectionTestSuite::LteCellSelectionTestSuite () : TestSuite ("lte-cell-selection", SYSTEM)
{
  ...
  AddTestCase (new LteCellSelectionTestCase ("EPC, real RRC, RngNum=1", true, false, 60.0, w, 1),
               //                                        isd       rngrun
               TestCase::QUICK);
  ...
  AddTestCase (new LteCellSelectionTestCase ("EPC, ideal RRC, RngNum=1", true, true, 60.0, w, 1),
               //                                        isd      rngrun
               TestCase::QUICK);
