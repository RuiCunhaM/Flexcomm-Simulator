    ...
    : TestSuite ("lte-ue-measurements-piecewise-3", SYSTEM)
{
  ...
  AddTestCase (new LteUeMeasurementsPiecewiseTestCase3 ("Piecewise test case 3 - Event A4", config,
                                                        expectedTime),
               TestCase::QUICK);
...
LteUeMeasurementsPiecewiseTestCase3::DoRun ()
{
   ...
   * 200 ms.
   */
  Simulator::Schedule (MilliSeconds (301), &LteUeMeasurementsPiecewiseTestCase3::TeleportEnbNear,
                       this);
