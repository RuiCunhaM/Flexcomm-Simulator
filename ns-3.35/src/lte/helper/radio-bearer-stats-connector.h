...
public:
   ...
   * \param rnti
   */
  static void CreatedSrb1Ue (RadioBearerStatsConnector *c, std::string context, uint64_t imsi,
                             uint16_t cellid, uint16_t rnti);
   ...
   * \param lcid
   */
  static void CreatedDrbEnb (RadioBearerStatsConnector *c, std::string context, uint64_t imsi,
   ...
   * \param lcid
   */
  static void CreatedDrbUe (RadioBearerStatsConnector *c, std::string context, uint64_t imsi,
                            uint16_t cellid, uint16_t rnti, uint8_t lcid);
...
private:
   ...
   * \param lcid
   */
  void ConnectTracesDrbEnb (std::string context, uint64_t imsi, uint16_t cellId, uint16_t rnti,
                            uint8_t lcid);
   ...
   * \param lcid
   */
  void ConnectTracesDrbUe (std::string context, uint64_t imsi, uint16_t cellId, uint16_t rnti,
                           uint8_t lcid);
