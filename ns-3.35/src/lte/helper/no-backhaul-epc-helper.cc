  ...
  static TypeId tid =
      TypeId ("ns3::NoBackhaulEpcHelper")
          ...
          .AddAttribute (
              ...
              MakeDataRateAccessor (&NoBackhaulEpcHelper::m_s5LinkDataRate), MakeDataRateChecker ())
          .AddAttribute ("S5LinkDelay", "The delay to be used for the next S5 link to be created",
                         TimeValue (Seconds (0)),
                         MakeTimeAccessor (&NoBackhaulEpcHelper::m_s5LinkDelay), MakeTimeChecker ())
          .AddAttribute ("S5LinkMtu", "The MTU of the next S5 link to be created",
                         UintegerValue (2000),
          ...
          .AddAttribute ("S11LinkDataRate",
                         ...
                         MakeDataRateChecker ())
          .AddAttribute ("S11LinkDelay", "The delay to be used for the next S11 link to be created",
                         TimeValue (Seconds (0)),
                         MakeTimeAccessor (&NoBackhaulEpcHelper::m_s11LinkDelay),
                         MakeTimeChecker ())
          .AddAttribute ("S11LinkMtu", "The MTU of the next S11 link to be created.",
                         UintegerValue (2000),
          ...
          .AddAttribute (
              ...
              DataRateValue (DataRate ("10Gb/s")),
              MakeDataRateAccessor (&NoBackhaulEpcHelper::m_x2LinkDataRate), MakeDataRateChecker ())
          .AddAttribute ("X2LinkDelay", "The delay to be used for the next X2 link to be created",
                         TimeValue (Seconds (0)),
                         MakeTimeAccessor (&NoBackhaulEpcHelper::m_x2LinkDelay), MakeTimeChecker ())
          ...
          .AddAttribute (
              ...
              MakeStringAccessor (&NoBackhaulEpcHelper::m_x2LinkPcapPrefix), MakeStringChecker ())
...
uint8_t
NoBackhaulEpcHelper::ActivateEpsBearer (Ptr<NetDevice> ueDevice, uint64_t imsi, Ptr<EpcTft> tft,
                                        EpsBearer bearer)
{
  ...
  NS_ASSERT_MSG (ueIpv4 != 0 || ueIpv6 != 0,
...
void
NoBackhaulEpcHelper::AddS1Interface (Ptr<Node> enb, Ipv4Address enbAddress, Ipv4Address sgwAddress,
                                     uint16_t cellId)
{
