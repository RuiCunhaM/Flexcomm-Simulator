...
void
RadioBearerStatsConnector::CreatedDrbEnb (RadioBearerStatsConnector *c, std::string context,
...
void
RadioBearerStatsConnector::CreatedSrb1Ue (RadioBearerStatsConnector *c, std::string context,
                                          uint64_t imsi, uint16_t cellId, uint16_t rnti)
{
  NS_LOG_FUNCTION (c << context << imsi << cellId << rnti);
...
void
RadioBearerStatsConnector::CreatedDrbUe (RadioBearerStatsConnector *c, std::string context,
                                         uint64_t imsi, uint16_t cellId, uint16_t rnti,
                                         uint8_t lcid)
{
  NS_LOG_FUNCTION (c << context << imsi << cellId << rnti << (uint16_t) lcid);
...
void
RadioBearerStatsConnector::ConnectTracesSrb0 (std::string context, uint64_t imsi, uint16_t cellId,
                                              uint16_t rnti)
{
...
void
RadioBearerStatsConnector::ConnectTracesSrb1 (std::string context, uint64_t imsi, uint16_t cellId,
                                              uint16_t rnti)
{
  NS_LOG_FUNCTION (this << context << imsi << cellId << rnti);
  std::string ueRrcPath = context.substr (0, context.rfind ("/"));
...
void
RadioBearerStatsConnector::ConnectTracesDrbEnb (std::string context, uint64_t imsi, uint16_t cellId,
...
void
RadioBearerStatsConnector::ConnectTracesDrbUe (std::string context, uint64_t imsi, uint16_t cellId,
                                               uint16_t rnti, uint8_t lcid)
{
  NS_LOG_FUNCTION (this << context << imsi << cellId << rnti << (uint16_t) lcid);
