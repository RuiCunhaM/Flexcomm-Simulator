...
struct INetStack
{
   ...
   */
  virtual struct INetDatagramSocket *
  new_udp_socket ()
  {
    return NULL;
  }
   ...
   */
  virtual int
  sysctl (const char *sysctl_name, void *oldval, size_t *oldlenp, void *newval, size_t newlen)
  {
    return -1;
  }
   ...
   */
  virtual int
  sysctl_set (const char *name, const char *value)
  {
    return -1;
  }
   ...
   */
  virtual int
  sysctl_get (const char *name, char *value, size_t len)
  {
    return -1;
  }
   ...
   */
  virtual int
  sysctl_getnum (size_t idx, char *name, size_t len)
  {
    return -1;
  }
   ...
   */
  virtual bool
  get_var (const char *var, char *result, int result_len)
  {
    return false;
  }
...
struct INetStreamSocket
{
   ...
   */
  virtual int
  getpeername (struct sockaddr *sa, size_t *salen)
  {
    return -1;
  }
  /**
   ...
   */
  virtual int
  getsockname (struct sockaddr *sa, size_t *salen)
  {
    return -1;
  }
  /**
