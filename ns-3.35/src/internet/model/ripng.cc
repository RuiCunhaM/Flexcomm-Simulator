...
RipNg::RipNg () : m_ipv6 (0), m_splitHorizonStrategy (RipNg::POISON_REVERSE), m_initialized (false)
{
...
Ptr<Ipv6Route>
RipNg::Lookup (Ipv6Address dst, Ptr<NetDevice> interface)
{
...
RipNgRoutingTableEntry::GetRouteStatus (void) const
{
  return m_status;
}
...
bool
RipNgRoutingTableEntry::IsRouteChanged (void) const
{
  return m_changed;
}
