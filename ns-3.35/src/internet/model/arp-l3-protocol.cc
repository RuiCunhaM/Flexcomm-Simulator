...
ArpL3Protocol::ArpL3Protocol () : m_tc (0)
{
      ...
      if (entry->IsExpired ())
        {
          if (entry->IsDead ())
            ...
            {
              NS_FATAL_ERROR ("Test for possibly unreachable code-- please file a bug report, with "
      ...
      else
        {
          if (entry->IsDead ())
            ...
            {
              NS_LOG_LOGIC ("Test for possibly unreachable code-- please file a bug report, with a "
