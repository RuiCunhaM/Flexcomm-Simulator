...
Icmpv4L4Protocol::Icmpv4L4Protocol () : m_node (0)
{
...
Icmpv4L4Protocol::Receive (Ptr<Packet> p, Ipv4Header const &header,
...
enum IpL4Protocol::RxStatus
Icmpv4L4Protocol::Receive (Ptr<Packet> p, Ipv6Header const &header,
