...
Rip::Rip () : m_ipv4 (0), m_splitHorizonStrategy (Rip::POISON_REVERSE), m_initialized (false)
{
...
Ptr<Ipv4Route>
Rip::Lookup (Ipv4Address dst, Ptr<NetDevice> interface)
{
...
RipRoutingTableEntry::GetRouteStatus (void) const
{
  return m_status;
}
...
bool
RipRoutingTableEntry::IsRouteChanged (void) const
{
  return m_changed;
}
