...
private:
  ...
  uint32_t
      m_gamma; //!< Fraction of queue to be removed per RTT when precautionary decongestion executed
  ...
  uint32_t
      m_rho; //!< Minimum number of consecutive RTT to consider competition with Reno flows on loss
