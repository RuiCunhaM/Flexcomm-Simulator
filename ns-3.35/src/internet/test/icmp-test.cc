  ...
  if (Inet6SocketAddress::IsMatchingType (from))
    {
      ...
      if (!(((int) icmpv6.GetType () >= 133) && ((int) icmpv6.GetType () <= 137)))
        {
          NS_TEST_EXPECT_MSG_EQ ((int) icmpv6.GetType (), Icmpv6Header::ICMPV6_ECHO_REPLY,
...
IcmpV6EchoReplyTestCase::DoRun ()
{
  ...
  NS_TEST_EXPECT_MSG_EQ (m_receivedPacket->GetSize (), 72,
  ...
  if (Inet6SocketAddress::IsMatchingType (from))
    {
      ...
      if (!(((int) icmpv6.GetType () >= 133) && ((int) icmpv6.GetType () <= 137)))
        {
          NS_TEST_EXPECT_MSG_EQ ((int) icmpv6.GetType (), Icmpv6Header::ICMPV6_ERROR_TIME_EXCEEDED,
