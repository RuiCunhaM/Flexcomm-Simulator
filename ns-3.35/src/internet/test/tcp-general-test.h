...
protected:
   ...
   */
  virtual void
  CongStateTrace (const TcpSocketState::TcpCongState_t oldValue,
   ...
   */
  virtual void
  CWndInflTrace (uint32_t oldValue, uint32_t newValue)
  {
    NS_UNUSED (oldValue);
    NS_UNUSED (newValue);
  }
   ...
   */
  virtual void
  RttTrace (Time oldTime, Time newTime)
  {
    NS_UNUSED (oldTime);
    NS_UNUSED (newTime);
  }
   ...
   */
  virtual void
  SsThreshTrace (uint32_t oldValue, uint32_t newValue)
  {
    NS_UNUSED (oldValue);
    NS_UNUSED (newValue);
  }
   ...
   */
  virtual void
  BytesInFlightTrace (uint32_t oldValue, uint32_t newValue)
  {
    NS_UNUSED (oldValue);
    NS_UNUSED (newValue);
  }
   ...
   */
  virtual void
  RtoTrace (Time oldValue, Time newValue)
  {
    NS_UNUSED (oldValue);
    NS_UNUSED (newValue);
  }
   ...
   */
  virtual void
  NextTxSeqTrace (SequenceNumber32 oldValue, SequenceNumber32 newValue)
  {
    NS_UNUSED (oldValue);
    NS_UNUSED (newValue);
  }
   ...
   */
  virtual void
  HighestTxSeqTrace (SequenceNumber32 oldValue, SequenceNumber32 newValue)
  {
    NS_UNUSED (oldValue);
    NS_UNUSED (newValue);
  }
   ...
   */
  virtual void
  RateUpdatedTrace (const TcpRateLinux::TcpRateConnection &rate)
  {
    NS_UNUSED (rate);
  }
   ...
   */
  virtual void
  RcvAck (const Ptr<const TcpSocketState> tcb, const TcpHeader &h, SocketWho who)
  {
    NS_UNUSED (tcb);
    NS_UNUSED (h);
    NS_UNUSED (who);
   ...
   */
  virtual void
  ProcessedAck (const Ptr<const TcpSocketState> tcb, const TcpHeader &h, SocketWho who)
  {
    NS_UNUSED (tcb);
    NS_UNUSED (h);
    NS_UNUSED (who);
   ...
   */
  virtual void
  AfterRTOExpired (const Ptr<const TcpSocketState> tcb, SocketWho who)
  {
    NS_UNUSED (tcb);
    NS_UNUSED (who);
  }
   ...
   */
  virtual void
  BeforeRTOExpired (const Ptr<const TcpSocketState> tcb, SocketWho who)
  {
    NS_UNUSED (tcb);
    NS_UNUSED (who);
  }
   ...
   */
  virtual void
  UpdatedRttHistory (const SequenceNumber32 &seq, uint32_t sz, bool isRetransmission, SocketWho who)
  {
    NS_UNUSED (seq);
    NS_UNUSED (sz);
   ...
   */
  virtual void
  DataSent (uint32_t size, SocketWho who)
  {
    NS_UNUSED (size);
    NS_UNUSED (who);
  }
