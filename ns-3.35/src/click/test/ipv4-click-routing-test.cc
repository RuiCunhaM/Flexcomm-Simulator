...
ClickIfidFromNameTest::ClickIfidFromNameTest () : TestCase ("Test SIMCLICK_IFID_FROM_NAME")
{
}
...
ClickIfidFromNameTest::DoRun ()
{
  ...
  AddNetworkDevice (node, Mac48Address ("00:00:00:00:00:01"), Ipv4Address ("10.1.1.1"),
...
ClickIpMacAddressFromNameTest::DoRun ()
{
  ...
  AddNetworkDevice (node, Mac48Address ("00:00:00:00:00:01"), Ipv4Address ("10.1.1.1"),
                    Ipv4Mask ("255.255.255.0"));
  AddNetworkDevice (node, Mac48Address ("00:00:00:00:00:02"), Ipv4Address ("10.1.1.2"),
                    Ipv4Mask ("255.255.255.0"));
  Ptr<Ipv4> ipv4 = node->GetObject<Ipv4> ();
  Ptr<Ipv4ClickRouting> click = DynamicCast<Ipv4ClickRouting> (ipv4->GetRoutingProtocol ());
  click->DoInitialize ();
  ...
  NS_TEST_EXPECT_MSG_EQ (strcmp (buf, "00:00:00:00:00:01"), 0,
  ...
  NS_TEST_EXPECT_MSG_EQ (strcmp (buf, "00:00:00:00:00:02"), 0,
