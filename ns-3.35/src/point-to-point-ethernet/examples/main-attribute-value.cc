...
// size of the FIFO queue in the PointToPointEthernetNetDevice
//
...
main (int argc, char *argv[])
{
  ...
  Ptr<PointToPointEthernetNetDevice> net0 = CreateObject<PointToPointEthernetNetDevice> ();
  n0->AddDevice (net0);
  ...
  // single PointToPointEthernetNetDevice (NetDevice 0) and added a
  // DropTailQueue to it.
  ...
  // queue via the PointToPointEthernetNetDevice attributes, where it is called
  // TxQueue
  PointerValue ptr;
