...
void
SpectrumChannelHelper::SetChannel (std::string type, std::string n0, const AttributeValue &v0,
...
void
SpectrumPhyHelper::SetPhy (std::string type, std::string n0, const AttributeValue &v0,
                           std::string n1, const AttributeValue &v1, std::string n2,
