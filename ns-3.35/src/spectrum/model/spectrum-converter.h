...
private:
  ...
  std::vector<double>
      m_conversionMatrix; //!< matrix of conversion coefficients stored in Compressed Row Storage format
  ...
  Ptr<const SpectrumModel>
      m_fromSpectrumModel; //!<  the SpectrumModel this SpectrumConverter instance can convert from
  Ptr<const SpectrumModel>
