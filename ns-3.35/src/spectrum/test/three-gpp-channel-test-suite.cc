...
private:
   ...
   */
  void CheckLongTermUpdate (Ptr<ThreeGppSpectrumPropagationLossModel> lossModel,
                            Ptr<SpectrumValue> txPsd, Ptr<MobilityModel> txMob,
                            Ptr<MobilityModel> rxMob, Ptr<SpectrumValue> rxPsdOld);
...
ThreeGppSpectrumPropagationLossModelTest::CheckLongTermUpdate (
    Ptr<ThreeGppSpectrumPropagationLossModel> lossModel, Ptr<SpectrumValue> txPsd,
    Ptr<MobilityModel> txMob, Ptr<MobilityModel> rxMob, Ptr<SpectrumValue> rxPsdOld)
{
...
ThreeGppSpectrumPropagationLossModelTest::DoRun ()
{
  ...
  Simulator::Schedule (MilliSeconds (101),
                       ...
                       lossModel, txPsd, txMob, rxMob, rxPsdOld);
