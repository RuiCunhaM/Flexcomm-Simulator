...
BulkSendBasicTestCase::BulkSendBasicTestCase () : TestCase ("Check a basic 300KB transfer")
{
}
...
void
BulkSendSeqTsSizeTestCase::SendTx (Ptr<const Packet> p, const Address &from, const Address &to,
                                   const SeqTsSizeHeader &header)
{
...
void
BulkSendSeqTsSizeTestCase::ReceiveRx (Ptr<const Packet> p, const Address &from, const Address &to,
                                      const SeqTsSizeHeader &header)
{
  // The header is not serialized onto the packet in this trace
...
BulkSendTestSuite::BulkSendTestSuite () : TestSuite ("bulk-send-application", UNIT)
{
