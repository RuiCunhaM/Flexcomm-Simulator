...
void
UdpClientServerTestCase::DoRun (void)
{
  NodeContainer n;
  n.Create (2);
...
void
UdpTraceClientServerTestCase::DoRun (void)
{
  NodeContainer n;
  n.Create (2);
...
void
PacketLossCounterTestCase::DoRun (void)
{
...
void
UdpEchoClientSetFillTestCase::DoRun (void)
{
  NodeContainer nodes;
  nodes.Create (2);
...
UdpClientServerTestSuite::UdpClientServerTestSuite () : TestSuite ("udp-client-server", UNIT)
{
