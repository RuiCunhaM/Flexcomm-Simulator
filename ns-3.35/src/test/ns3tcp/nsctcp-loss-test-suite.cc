...
NscTcpLossTestCase1::NscTcpLossTestCase1 ()
    : TestCase ("Check that nsc TCP survives loss of first two SYNs"), m_writeResults (false)
{
}
...
NscTcpLossTestCase2::NscTcpLossTestCase2 ()
    : TestCase ("Check that nsc TCP survives loss of first data packet"), m_writeResults (false)
{
}
...
NscTcpLossTestSuite::NscTcpLossTestSuite () : TestSuite ("nsc-tcp-loss", SYSTEM)
{
