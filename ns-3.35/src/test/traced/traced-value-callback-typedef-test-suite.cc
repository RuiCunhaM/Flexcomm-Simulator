...
template <>
inline std::string
TypeName<int8_t> (void)
{
  return "Int8_t";
}
template <>
inline std::string
TypeName<int16_t> (void)
{
  return "Int16_t";
}
template <>
inline std::string
TypeName<int32_t> (void)
{
  return "Int32_t";
}
template <>
inline std::string
TypeName<int64_t> (void)
{
  return "Int64_t";
}
template <>
inline std::string
TypeName<uint8_t> (void)
{
  return "Uint8_t";
}
template <>
inline std::string
TypeName<uint16_t> (void)
{
  return "Uint16_t";
}
template <>
inline std::string
TypeName<uint32_t> (void)
{
  return "Uint32_t";
}
template <>
inline std::string
TypeName<uint64_t> (void)
{
  return "Uint64_t";
}
template <>
inline std::string
TypeName<double> (void)
{
  return "Double";
}
template <>
...
template <>
inline std::string
TypeName<SequenceNumber32> (void)
{
...
{
  std::cout << ": " << (int64_t) oldValue << " -> " << (int64_t) newValue << std::endl;
  if (oldValue != 0)
