...
get_unaligned_u16 (const uint16_t *p_)
{
...
static inline void
put_unaligned_u16 (uint16_t *p_, uint16_t x_)
{
...
get_unaligned_u32 (const uint32_t *p_)
{
  const uint8_t *p = (const uint8_t *) p_;
...
static inline void
put_unaligned_u32 (uint32_t *p_, uint32_t x_)
{
  uint8_t *p = (uint8_t *) p_;
  uint32_t x = ntohl (x_);
...
get_unaligned_u64 (const uint64_t *p_)
{
  const uint8_t *p = (const uint8_t *) p_;
  return ntohll (((uint64_t) p[0] << 56) | ((uint64_t) p[1] << 48) | ((uint64_t) p[2] << 40) |
                 ((uint64_t) p[3] << 32) | (p[4] << 24) | (p[5] << 16) | (p[6] << 8) | p[7]);
}

static inline void
put_unaligned_u64 (uint64_t *p_, uint64_t x_)
{
  uint8_t *p = (uint8_t *) p_;
