...
OFSwitch13PriorityQueue::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::OFSwitch13PriorityQueue")
          ...
          .AddAttribute ("NumQueues", "The number of internal priority queues.",
          ...
          .AddAttribute ("QueueFactory", "The object factory for internal priority queues.",
...
OFSwitch13PriorityQueue::OFSwitch13PriorityQueue ()
    : OFSwitch13Queue (), NS_LOG_TEMPLATE_DEFINE ("OFSwitch13PriorityQueue")
{
