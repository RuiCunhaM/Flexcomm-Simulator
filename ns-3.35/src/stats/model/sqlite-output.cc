...
SQLiteOutput::WaitPrepare (sqlite3 *db, sqlite3_stmt **stmt, const std::string &cmd) const
{
  ...
  NS_ABORT_MSG_IF (sem == SEM_FAILED, "FAILED to open system semaphore, errno: " << errno);
...
bool
SQLiteOutput::CheckError (sqlite3 *db, int rc, const std::string &cmd, sem_t *sem, bool hardExit)
{
