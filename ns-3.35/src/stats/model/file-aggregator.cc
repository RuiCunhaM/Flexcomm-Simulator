  ...
  if (m_enabled)
    {
      ...
      if (m_fileType == FORMATTED)
        ...
        {
          // Write the values with the proper separator.
          m_file << v1 << m_separator << v2 << m_separator << v3 << m_separator << v4 << std::endl;
        }
    }
}
  ...
  if (m_enabled)
    {
      ...
      if (m_fileType == FORMATTED)
        ...
        {
          // Write the values with the proper separator.
          m_file << v1 << m_separator << v2 << m_separator << v3 << m_separator << v4 << m_separator
                 << v5 << std::endl;
        }
    }
}
...
void
FileAggregator::Write6d (std::string context, double v1, double v2, double v3, double v4, double v5,
                         double v6)
{
...
void
FileAggregator::Write7d (std::string context, double v1, double v2, double v3, double v4, double v5,
                         double v6, double v7)
{
...
void
FileAggregator::Write8d (std::string context, double v1, double v2, double v3, double v4, double v5,
...
void
FileAggregator::Write9d (std::string context, double v1, double v2, double v3, double v4, double v5,
      ...
      if (m_fileType == FORMATTED)
        {
          ...
          // Format the values.
          int charWritten = snprintf (buffer, maxBufferSize, m_9dFormat.c_str (), v1, v2, v3, v4,
                                      v5, v6, v7, v8, v9);
          if (charWritten < 0)
            {
              NS_LOG_DEBUG ("Error writing values to output file");
...
void
FileAggregator::Write10d (std::string context, double v1, double v2, double v3, double v4,
      ...
      if (m_fileType == FORMATTED)
        {
          ...
          // Format the values.
          int charWritten = snprintf (buffer, maxBufferSize, m_10dFormat.c_str (), v1, v2, v3, v4,
                                      v5, v6, v7, v8, v9, v10);
          if (charWritten < 0)
            {
              NS_LOG_DEBUG ("Error writing values to output file");
