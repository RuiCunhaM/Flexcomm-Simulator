...
void
GnuplotAggregator::Write2dWithXErrorDelta (std::string context, double x, double y,
                                           double errorDelta)
{
...
void
GnuplotAggregator::Write2dWithYErrorDelta (std::string context, double x, double y,
                                           double errorDelta)
{
  NS_LOG_FUNCTION (this << context << x << y << errorDelta);
...
void
GnuplotAggregator::Write2dWithXYErrorDelta (std::string context, double x, double y,
...
void
GnuplotAggregator::Set2dDatasetStyle (const std::string &dataset,
