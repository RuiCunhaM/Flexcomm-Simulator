...
// -----------------------------------------------------------------------------
bool
AreVectorsEqual (Vector const &actual, Vector const &limit, double tol)
{
...
public:
  ...
  struct ReferencePoint
  {
     ...
     */
    bool
    operator< (ReferencePoint const &o) const
    {
      return (time < o.time);
    }
  };
   ...
   */
  void
  SetTrace (std::string const &trace)
  {
    m_trace = trace;
  }
  /**
   ...
   */
  void
  AddReferencePoint (ReferencePoint const &r)
  {
   ...
   */
  void
  AddReferencePoint (const char *id, double sec, Vector const &p, Vector const &v)
  {
