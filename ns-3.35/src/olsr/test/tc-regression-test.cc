...
TcRegressionTest::ReceivePktProbeA (Ptr<Socket> socket)
{
  ...
  if (m_countA == 0)
  ...
  else if (m_countA == 1)
    {
      ...
      NS_TEST_EXPECT_MSG_EQ (hello.linkMessages[0].neighborInterfaceAddresses.size (), 1,
                             "1 - Neighbor.");
      ...
      NS_TEST_EXPECT_MSG_EQ (hello.linkMessages[1].neighborInterfaceAddresses.size (), 1,
                             "1 - Neighbor.");
      ...
      if (m_countA != 8)
        {
          ...
          NS_TEST_EXPECT_MSG_EQ (hello.linkMessages[0].neighborInterfaceAddresses.size (), 1,
                                 int (m_countA) << " - Neighbor.");
          NS_TEST_EXPECT_MSG_EQ (hello.linkMessages[0].neighborInterfaceAddresses[0],
                                 Ipv4Address ("10.1.1.3"), int (m_countA) << " - Neighbor.");
          NS_TEST_EXPECT_MSG_EQ (hello.linkMessages[1].linkCode, 6,
                                 int (m_countA) << " - Symmetric Link.");
          NS_TEST_EXPECT_MSG_EQ (hello.linkMessages[1].neighborInterfaceAddresses.size (), 1,
                                 int (m_countA) << " - Neighbor.");
          NS_TEST_EXPECT_MSG_EQ (hello.linkMessages[1].neighborInterfaceAddresses[0],
                                 Ipv4Address ("10.1.1.1"), int (m_countA) << " - Neighbor.");
        }
    }
  m_countA++;
}
...
TcRegressionTest::ReceivePktProbeB (Ptr<Socket> socket)
{
  ...
  if (m_countB == 0 || m_countB == 2 || m_countB == 5 || m_countB == 6 || m_countB == 8 ||
    ...
    {
      NS_TEST_EXPECT_MSG_EQ (msgHdr.GetOriginatorAddress (), Ipv4Address ("10.1.1.3"),
                             "Originator address.");
    }
  else
    {
  ...
  if (m_countB == 0 || m_countB == 1)
  ...
  else
    {
      ...
      NS_TEST_EXPECT_MSG_EQ (hello.linkMessages[0].neighborInterfaceAddresses[0],
                             Ipv4Address ("10.1.1.2"), int (m_countC) << " - Neighbor.");
    }
      ...
      if (m_countC != 8)
        {
          ...
          NS_TEST_EXPECT_MSG_EQ (hello.linkMessages[0].neighborInterfaceAddresses.size (), 1,
                                 int (m_countC) << " - Neighbor.");
          NS_TEST_EXPECT_MSG_EQ (hello.linkMessages[0].neighborInterfaceAddresses[0],
                                 Ipv4Address ("10.1.1.3"), int (m_countC) << " - Neighbor.");
          NS_TEST_EXPECT_MSG_EQ (hello.linkMessages[1].linkCode, 6,
                                 int (m_countC) << " - Symmetric Link.");
          NS_TEST_EXPECT_MSG_EQ (hello.linkMessages[1].neighborInterfaceAddresses.size (), 1,
                                 int (m_countC) << " - Neighbor.");
          NS_TEST_EXPECT_MSG_EQ (hello.linkMessages[1].neighborInterfaceAddresses[0],
                                 Ipv4Address ("10.1.1.1"), int (m_countC) << " - Neighbor.");
        }
    }
  m_countC++;
}
