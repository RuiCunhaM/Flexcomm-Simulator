  ...
  for (iter = hello.linkMessages.begin (); iter != hello.linkMessages.end (); iter++)
    {
      ...
      NS_TEST_EXPECT_MSG_EQ (iter->neighborInterfaceAddresses[0], Ipv4Address ("10.1.1.1"),
                             "Only one neighbor.");
    }
  ...
  for (iter = hello.linkMessages.begin (); iter != hello.linkMessages.end (); iter++)
    {
      ...
      NS_TEST_EXPECT_MSG_EQ (iter->neighborInterfaceAddresses.size (), 1, "Only one neighbor.");
      NS_TEST_EXPECT_MSG_EQ (iter->neighborInterfaceAddresses[0], Ipv4Address ("10.1.1.2"),
                             "Only one neighbor.");
    }
