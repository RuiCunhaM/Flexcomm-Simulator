...
public:
   ...
   */
  void
  SetPacketLength (uint16_t length)
  {
   ...
   */
  void
  SetPacketSequenceNumber (uint16_t seqnum)
  {
...
public:
   ...
   */
  void
  SetMessageSequenceNumber (uint16_t messageSequenceNumber)
  {
