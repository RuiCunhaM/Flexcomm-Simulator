  ...
  if (!station->m_isHt)
  ...
  else
    {
      ...
      if (((group.type == GROUP_HE) && (group.gi < GetGuardInterval (station))) ||
          (((group.type == GROUP_HT) || (group.type == GROUP_VHT)) && (group.gi == 400) &&
          ...
          (group.streams > GetNumberOfSupportedStreams (station)))
        {
          NS_FATAL_ERROR (
              ...
              << ((group.type == GROUP_HE) ? GetGuardInterval (station)
      ...
      return WifiTxVector (
          ...
          group.gi, GetNumberOfAntennas (), group.streams, GetNess (station),
      ...
      if (m_minstrelGroups[groupId].isSupported)
        {
          ...
          if (!GetHeSupported (station) && (m_minstrelGroups[groupId].type != GROUP_VHT) &&
          ...
          if (((m_minstrelGroups[groupId].type == GROUP_HT) ||
               (m_minstrelGroups[groupId].type == GROUP_VHT)) &&
