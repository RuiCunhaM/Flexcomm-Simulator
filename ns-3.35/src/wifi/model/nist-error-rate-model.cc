...
double
NistErrorRateModel::GetFecQamBer (uint16_t constellationSize, double snr, uint64_t nbits,
...
double
NistErrorRateModel::DoGetChunkSuccessRate (WifiMode mode, const WifiTxVector &txVector, double snr,
