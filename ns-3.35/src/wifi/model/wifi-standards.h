...
*/
inline std::ostream &
operator<< (std::ostream &os, WifiPhyStandard standard)
{
  switch (standard)
    {
...
*/
inline std::ostream &
operator<< (std::ostream &os, WifiMacStandard standard)
{
  switch (standard)
    {
...
const std::map<WifiStandard, WifiStandardInfo> wifiStandards = {
    ...
    {WIFI_STANDARD_80211b,
     {WIFI_PHY_STANDARD_80211b, WIFI_PHY_BAND_2_4GHZ, WIFI_MAC_STANDARD_80211}},
    {WIFI_STANDARD_80211g,
     {WIFI_PHY_STANDARD_80211g, WIFI_PHY_BAND_2_4GHZ, WIFI_MAC_STANDARD_80211}},
    ...
    {WIFI_STANDARD_80211n_5GHZ,
     {WIFI_PHY_STANDARD_80211n, WIFI_PHY_BAND_5GHZ, WIFI_MAC_STANDARD_80211n}},
    {WIFI_STANDARD_80211ac,
     {WIFI_PHY_STANDARD_80211ac, WIFI_PHY_BAND_5GHZ, WIFI_MAC_STANDARD_80211ac}},
    {WIFI_STANDARD_80211ax_2_4GHZ,
     {WIFI_PHY_STANDARD_80211ax, WIFI_PHY_BAND_2_4GHZ, WIFI_MAC_STANDARD_80211ax}},
    {WIFI_STANDARD_80211ax_5GHZ,
     {WIFI_PHY_STANDARD_80211ax, WIFI_PHY_BAND_5GHZ, WIFI_MAC_STANDARD_80211ax}},
    {WIFI_STANDARD_80211ax_6GHZ,
     {WIFI_PHY_STANDARD_80211ax, WIFI_PHY_BAND_6GHZ, WIFI_MAC_STANDARD_80211ax}}};
...
GetFrequencyChannelType (WifiPhyStandard standard)
{
  switch (standard)
    {
    case WIFI_PHY_STANDARD_80211b:
 ...
 */
inline uint16_t
GetMaximumChannelWidth (WifiPhyStandard standard)
{
  switch (standard)
    {
    case WIFI_PHY_STANDARD_80211b:
 ...
 */
inline uint16_t
GetDefaultChannelWidth (WifiPhyStandard standard, WifiPhyBand band)
{
  switch (standard)
    {
    case WIFI_PHY_STANDARD_80211b:
