...
public:
   ...
   */
  double GetChunkSuccessRate (WifiMode mode, const WifiTxVector &txVector, double snr,
                              uint64_t nbits, uint8_t numRxAntennas = 1,
...
private:
   ...
   * \return probability of successfully receiving the chunk
   */
  virtual double DoGetChunkSuccessRate (WifiMode mode, const WifiTxVector &txVector, double snr,
