...
private:
  ...
  uint8_t
      m_htSupported; ///< Flag to indicate HT is supported in order to decide whether this element should be added to the frame or not
  uint8_t
      m_vhtSupported; ///< Flag to indicate VHT is supported in order to decide whether this element should be added to the frame or not
};
