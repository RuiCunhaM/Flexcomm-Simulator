  ...
  static TypeId tid =
      TypeId ("ns3::WifiNetDevice")
          ...
          .AddAttribute ("Phy", "The PHY layer attached to this device.", PointerValue (),
                         MakePointerAccessor (&WifiNetDevice::GetPhy, &WifiNetDevice::SetPhy),
...
WifiNetDevice::WifiNetDevice () : m_configComplete (false)
{
...
{
  if (m_mac == 0 || m_phy == 0 || m_stationManager == 0 || m_node == 0 || m_configComplete)
    {
      return;
    }
