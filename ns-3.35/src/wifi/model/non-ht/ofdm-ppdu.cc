...
OfdmPpdu::OfdmPpdu (Ptr<const WifiPsdu> psdu, const WifiTxVector &txVector, WifiPhyBand band,
                    uint64_t uid, bool instantiateLSig /* = true */)
    : WifiPpdu (psdu, txVector, uid), m_band (band), m_channelWidth (txVector.GetChannelWidth ())
{
