...
OfdmPhy::CreateOfdmMode (std::string uniqueName, bool isMandatory)
{
  ...
  return WifiModeFactory::CreateWifiMode (
      ...
      MakeBoundCallback (&GetPhyRate, uniqueName), MakeCallback (&GetPhyRateFromTxVector),
      MakeBoundCallback (&GetDataRate, uniqueName), MakeCallback (&GetDataRateFromTxVector),
...
uint64_t
OfdmPhy::GetPhyRate (const std::string &name, uint16_t channelWidth, uint16_t guardInterval,
                     uint8_t nss)
{
...
uint64_t
OfdmPhy::GetDataRate (const std::string &name, uint16_t channelWidth, uint16_t guardInterval,
                      uint8_t nss)
{
  WifiCodeRate codeRate = GetCodeRate (name);
...
OfdmPhy::CalculateDataRate (WifiCodeRate codeRate, uint16_t constellationSize,
                            uint16_t channelWidth, uint16_t /* guardInterval */, uint8_t /* nss */)
{
  ...
  return CalculateDataRate (symbolDuration, guardInterval, 48,
