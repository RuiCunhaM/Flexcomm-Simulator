                                                  ...
                                                  const WifiTxParameters &txParams)
{
  ...
  if (edca->GetBaManager ()->GetBar (true, tid, receiver) != 0 ||
      (acknowledgment != nullptr && (!acknowledgment->stationsReplyingWithNormalAck.empty () ||
                                            ...
                                            const WifiTxParameters &txParams)
{
  ...
  Ptr<HeFrameExchangeManager> heFem =
      DynamicCast<HeFrameExchangeManager> (m_mac->GetFrameExchangeManager ());
