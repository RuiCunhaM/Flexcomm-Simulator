...
public:
  ...
  TryAddMpdu (Ptr<const WifiMacQueueItem> mpdu, const WifiTxParameters &txParams) override;
  virtual std::unique_ptr<WifiAcknowledgment>
  TryAggregateMsdu (Ptr<const WifiMacQueueItem> msdu, const WifiTxParameters &txParams) override;
...
private:
   ...
   */
  virtual std::unique_ptr<WifiAcknowledgment>
  GetAckInfoIfBarBaSequence (Ptr<const WifiMacQueueItem> mpdu, const WifiTxParameters &txParams);
  /**
   * Compute the information about the acknowledgment of the current multi-user frame
   * (as described by the given TX parameters) if the given MPDU is added. If the
   * computed information is the same as the current one, a null pointer is returned.
   ...
   */
  virtual std::unique_ptr<WifiAcknowledgment>
  GetAckInfoIfTfMuBar (Ptr<const WifiMacQueueItem> mpdu, const WifiTxParameters &txParams);
  /**
   * Compute the information about the acknowledgment of the current multi-user frame
   * (as described by the given TX parameters) if the given MPDU is added. If the
   * computed information is the same as the current one, a null pointer is returned.
   ...
   */
  virtual std::unique_ptr<WifiAcknowledgment>
  GetAckInfoIfAggregatedMuBar (Ptr<const WifiMacQueueItem> mpdu, const WifiTxParameters &txParams);
   ...
   */
  virtual std::unique_ptr<WifiAcknowledgment>
  TryUlMuTransmission (Ptr<const WifiMacQueueItem> mpdu, const WifiTxParameters &txParams);
