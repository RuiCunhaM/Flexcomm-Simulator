...
void
WifiPhyStateHelper::ContinueRxNextMpdu (Ptr<WifiPsdu> psdu, RxSignalInfo rxSignalInfo,
                                        WifiTxVector txVector)
{
                                       ...
                                       std::vector<bool> statusPerMpdu)
{
  ...
  NS_ASSERT (Abs (m_endRx - Simulator::Now ()) <
             MicroSeconds (1)); //1us corresponds to the maximum propagation delay (delay spread)
