...
private:
   ...
   * \return double
   */
  double GetFecBpskBer (double snr, uint64_t nbits, uint32_t signalSpread, uint64_t phyRate,
   ...
   * \return double
   */
  double GetFecQamBer (double snr, uint64_t nbits, uint32_t signalSpread, uint64_t phyRate,
                       uint32_t m, uint32_t dfree, uint32_t adFree, uint32_t adFreePlusOne) const;
};
