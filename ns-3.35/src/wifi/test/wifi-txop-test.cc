...
WifiTxopTest::CheckResults (void)
{
  ...
  if (m_pifsRecovery)
    {
      NS_TEST_EXPECT_MSG_EQ (tEnd + sifs + slot, tStart,
  ...
  NS_TEST_EXPECT_MSG_EQ (m_txPsdus[17].header.IsRts (), true, "Expected an RTS frame");
  NS_TEST_EXPECT_MSG_EQ (
  ...
  NS_TEST_EXPECT_MSG_EQ (m_txPsdus[19].header.IsQosData (), true, "Expected a QoS data frame");
  NS_TEST_EXPECT_MSG_EQ (
  ...
  NS_TEST_EXPECT_MSG_EQ (m_txPsdus[21].header.IsRts (), true, "Expected an RTS frame");
  NS_TEST_EXPECT_MSG_EQ (
  ...
  NS_TEST_EXPECT_MSG_EQ (m_txPsdus[23].header.IsQosData (), true, "Expected a QoS data frame");
  NS_TEST_EXPECT_MSG_EQ (
