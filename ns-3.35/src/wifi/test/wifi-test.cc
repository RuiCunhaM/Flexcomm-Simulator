...
Bug2470TestCase::RunSubtest (PointerValue apErrorModel, PointerValue staErrorModel)
{
  ...
  Config::Connect ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/BE_Txop/"
...
IdealRateManagerChannelWidthTest::ChangeChannelWidth (uint16_t channelWidth)
{
  ...
  Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Phy/Frequency",
               UintegerValue (frequency));
}
