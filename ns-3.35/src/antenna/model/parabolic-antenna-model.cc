...
ParabolicAntennaModel::GetTypeId ()
{
  static TypeId tid =
      TypeId ("ns3::ParabolicAntennaModel")
          ...
          .AddAttribute ("Beamwidth", "The 3dB beamwidth (degrees)", DoubleValue (60),
          ...
          .AddAttribute ("Orientation",
                         "The angle (degrees) that expresses the orientation of the antenna on the "
                         "x-y plane relative to the x axis",
                         DoubleValue (0.0),
          ...
          .AddAttribute (
              ...
              DoubleValue (20.0), MakeDoubleAccessor (&ParabolicAntennaModel::m_maxAttenuation),
