  ...
  for (int i = 0; i < nbSS / 2; i++)
    {
      IpcsClassifierRecord DlClassifierBe (
          ...
          Ipv4Mask ("255.255.255.255"), 0, 65000, 100 + (i * 10), 100 + (i * 10), 17, 1);
      ServiceFlow DlServiceFlowBe = wimax.CreateServiceFlow (
          ServiceFlow::SF_DIRECTION_DOWN, ServiceFlow::SF_TYPE_BE, DlClassifierBe);
      ...
      IpcsClassifierRecord ulClassifierBe (SSinterfaces.GetAddress (i + (nbSS / 2)),
                                           ...
                                           Ipv4Mask ("0.0.0.0"), 0, 65000, 100 + (i * 10),
                                           100 + (i * 10), 17, 1);
