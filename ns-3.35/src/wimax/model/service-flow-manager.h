...
public:
  ...
  GetServiceFlows (enum ServiceFlow::SchedulingType schedulingType) const;
   ...
   */
  ServiceFlow *DoClassify (Ipv4Address SrcAddress, Ipv4Address DstAddress, uint16_t SrcPort,
