...
private:
  ...
  Time
      m_grantTimeStamp; ///< allocation (for data) for UGS flows and unicast poll (for bandwidth requests) for non-UGS flows
  ...
  uint32_t
      m_grantedBandwidthTemp; ///< Temporary variable used to sort list. Necessary to keep original order
