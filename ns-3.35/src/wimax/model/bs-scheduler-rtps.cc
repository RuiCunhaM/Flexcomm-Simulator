...
void
BSSchedulerRtps::AddDownlinkBurst (Ptr<const WimaxConnection> connection, uint8_t diuc,
  ...
  if (m_downlinkBursts->size ())
    {
      NS_LOG_DEBUG (
          ...
          << " primary "
          << GetBs ()->GetConnectionManager ()->GetNPackets (Cid::PRIMARY,
...
Ptr<PacketBurst>
BSSchedulerRtps::CreateUgsBurst (ServiceFlow *serviceFlow, WimaxPhy::ModulationType modulationType,
