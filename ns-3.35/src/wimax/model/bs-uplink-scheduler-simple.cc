...
void
UplinkSchedulerSimple::GetChannelDescriptorsToUpdate (bool &updateDcd, bool &updateUcd,
...
void
UplinkSchedulerSimple::AddUplinkAllocation (OfdmUlMapIe &ulMapIe, const uint32_t &allocationSize,
