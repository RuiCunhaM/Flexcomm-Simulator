...
TypeId
BurstProfileManager::GetTypeId (void)
{
  static TypeId tid =
...
BurstProfileManager::BurstProfileManager (Ptr<WimaxNetDevice> device) : m_device (device)
{
}
...
uint16_t
BurstProfileManager::GetNrBurstProfilesToDefine (void)
{
  /*
   * 7 modulation types
   */
...
uint8_t
BurstProfileManager::GetBurstProfileForSS (const SSRecord *ssRecord, const RngReq *rngreq,
