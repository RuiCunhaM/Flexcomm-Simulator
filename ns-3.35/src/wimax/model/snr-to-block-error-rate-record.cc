...
SNRToBlockErrorRateRecord::SNRToBlockErrorRateRecord (double snrValue, double bitErrorRate,
                                                      double blockErrorRate, double sigma2,
                                                      double I1, double I2)
{
  m_snrValue = snrValue;
...
{
  return (new SNRToBlockErrorRateRecord (m_snrValue, m_bitErrorRate, m_blockErrorRate, m_sigma2,
                                         m_i1, m_i2));
}
