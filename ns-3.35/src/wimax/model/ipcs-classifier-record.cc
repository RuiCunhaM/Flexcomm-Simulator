...
IpcsClassifierRecord::IpcsClassifierRecord (Ipv4Address SrcAddress, Ipv4Mask SrcMask,
...
bool
IpcsClassifierRecord::CheckMatch (Ipv4Address srcAddress, Ipv4Address dstAddress, uint16_t srcPort,
...
IpcsClassifierRecord::ToTlv (void) const
{
  ...
  Tlv tmp_tlv (CsParamVectorTlvValue::Packet_Classification_Rule, ClassVectVal.GetSerializedSize (),
               ClassVectVal);
