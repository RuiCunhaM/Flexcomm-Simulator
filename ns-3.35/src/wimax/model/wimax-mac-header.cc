...
MacHeaderType::MacHeaderType (void) : m_type (0)
{
}
...
TypeId
MacHeaderType::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
...
uint32_t
MacHeaderType::GetSerializedSize (void) const
{
  return 0;
}
...
uint8_t
GenericMacHeader::GetHt (void) const
{
  return m_ht;
}

uint8_t
GenericMacHeader::GetEc (void) const
{
  return m_ec;
}

uint8_t
GenericMacHeader::GetType (void) const
{
  return m_type;
}

uint8_t
GenericMacHeader::GetCi (void) const
{
  return m_ci;
}

uint8_t
GenericMacHeader::GetEks (void) const
{
  return m_eks;
}

uint16_t
GenericMacHeader::GetLen (void) const
{
  return m_len;
}

Cid
GenericMacHeader::GetCid (void) const
{
  return m_cid;
}

uint8_t
GenericMacHeader::GetHcs (void) const
{
  return m_hcs;
}

std::string
GenericMacHeader::GetName (void) const
{
  return "Generic Mac Header";
}

TypeId
GenericMacHeader::GetTypeId (void)
{
...
TypeId
GenericMacHeader::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
...
uint32_t
GenericMacHeader::GetSerializedSize (void) const
{
  return 6;
}
...
bool
GenericMacHeader::check_hcs (void) const
{
  return (m_hcs == c_hcs);
}
...
uint8_t
BandwidthRequestHeader::GetHt (void) const
{
  return m_ht;
}

uint8_t
BandwidthRequestHeader::GetEc (void) const
{
  return m_ec;
}

uint8_t
BandwidthRequestHeader::GetType (void) const
{
  return m_type;
}

uint32_t
BandwidthRequestHeader::GetBr (void) const
{
  return m_br;
}

Cid
BandwidthRequestHeader::GetCid (void) const
{
  return m_cid;
}

uint8_t
BandwidthRequestHeader::GetHcs (void) const
{
  return m_hcs;
}

std::string
BandwidthRequestHeader::GetName (void) const
{
  return "Bandwidth Request Header";
}

TypeId
BandwidthRequestHeader::GetTypeId (void)
{
...
TypeId
BandwidthRequestHeader::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
...
uint32_t
BandwidthRequestHeader::GetSerializedSize (void) const
{
  /*
...
bool
BandwidthRequestHeader::check_hcs (void) const
{
  return (m_hcs == c_hcs);
}
...
GrantManagementSubheader::GrantManagementSubheader (void) : m_si (0), m_pm (0), m_pbr (0)
{
}
...
uint8_t
GrantManagementSubheader::GetSi (void) const
{
  return m_si;
}

uint8_t
GrantManagementSubheader::GetPm (void) const
{
  return m_pm;
}

uint16_t
GrantManagementSubheader::GetPbr (void) const
{
  return m_pbr;
}

std::string
GrantManagementSubheader::GetName (void) const
{
  return "Grant Management Subheader";
}

TypeId
GrantManagementSubheader::GetTypeId (void)
{
...
TypeId
GrantManagementSubheader::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
...
uint32_t
GrantManagementSubheader::GetSerializedSize (void) const
{
  return 1 + 1 + 2;
}
...
FragmentationSubheader::FragmentationSubheader (void) : m_fc (0), m_fsn (0)
{
}
