 ...
 */
static void
AsciiPhyTxEvent (std::ostream *os, std::string context, Ptr<const Packet> packet, double txPowerDb,
                 UanTxMode mode)
{
  NS_UNUSED (txPowerDb);
 ...
 */
static void
AsciiPhyRxOkEvent (std::ostream *os, std::string context, Ptr<const Packet> packet, double snr,
                   UanTxMode mode)
{
  NS_UNUSED (snr);
...
void
UanHelper::SetMac (std::string macType, std::string n0, const AttributeValue &v0, std::string n1,
...
void
UanHelper::SetPhy (std::string phyType, std::string n0, const AttributeValue &v0, std::string n1,
                   const AttributeValue &v1, std::string n2, const AttributeValue &v2,
                   std::string n3, const AttributeValue &v3, std::string n4,
                   const AttributeValue &v4, std::string n5, const AttributeValue &v5,
                   std::string n6, const AttributeValue &v6, std::string n7,
...
void
UanHelper::SetTransducer (std::string type, std::string n0, const AttributeValue &v0,
