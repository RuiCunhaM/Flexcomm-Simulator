...
UanHeaderRcData::UanHeaderRcData () : Header (), m_frameNo (0), m_propDelay (Seconds (0))
{
}
...
UanHeaderRcRts::UanHeaderRcRts (uint8_t frameNo, uint8_t retryNo, uint8_t noFrames, uint16_t length,
                                Time timeStamp)
    : Header (),
      m_frameNo (frameNo),
      m_noFrames (noFrames),
...
UanHeaderRcCtsGlobal::UanHeaderRcCtsGlobal () : Header (), m_retryRate (0), m_rateNum (0)
{
}

UanHeaderRcCtsGlobal::UanHeaderRcCtsGlobal (Time wt, Time ts, uint16_t rate, uint16_t retryRate)
    : Header (), m_timeStampTx (ts), m_winTime (wt), m_retryRate (retryRate), m_rateNum (rate)
{
}
...
UanHeaderRcCts::UanHeaderRcCts (uint8_t frameNo, uint8_t retryNo, Time ts, Time delay,
                                Mac8Address addr)
    : Header (),
      m_frameNo (frameNo),
      m_timeStampRts (ts),
