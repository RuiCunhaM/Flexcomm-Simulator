 ...
 */
template <typename T>
class NixVectorRouting : public std::enable_if<std::is_same<Ipv4RoutingProtocol, T>::value ||
                                                   std::is_same<Ipv6RoutingProtocol, T>::value,
                                               T>::type
{
...
private:
  ...
  typedef typename std::conditional<IsIpv4::value, UnicastForwardCallbackv4,
                                    UnicastForwardCallbackv6>::type UnicastForwardCallback;
  ...
  typedef typename std::conditional<IsIpv4::value, MulticastForwardCallbackv4,
                                    MulticastForwardCallbackv6>::type MulticastForwardCallback;
